...
MANIFIESTOS_ORACULO = {
    ...
    "stressed": [ # Corregido a 'stressed' para coincidir con la mente
...
BASE_MISIONES = {
   "CASA_ES": [
  {"id": 1, "titulo": "Corta el piloto automático", "descripcion": "Toma un instante para escanear tu cuerpo por completo. Ubica el peso exacto acumulado en tu espalda alta y míralo con absoluta calma. Siente tus latidos y recuérdate vivo en este segundo de paz.", "vector_necesidades": {"contemplacion": 90, "descanso": 80, "silencio": 70, "organizacion": 50, "movimiento": 30}},
  {"id": 2, "titulo": "Desconexión total", "descripcion": "Siente la forma de la silla debajo de tu cuerpo ahora mismo. El suelo firme sostiene todo tu peso de manera completamente gratuita y segura. No luches, déjate caer en una total calma en este instante.", "vector_necesidades": {"descanso": 90, "contemplacion": 80, "silencio": 70, "organizacion": 40, "esperanza": 60}},
  {"id": 3, "titulo": "Aislamiento de pantalla", "descripcion": "Voltea tu teléfono celular hacia abajo con total tranquilidad en este instante. Mira una esquina del techo por treinta segundos seguidos y permite que tu mente rompa el bucle de la prisa digital ahora.", "vector_necesidades": {"silencio": 95, "descanso": 85, "contemplacion": 90, "organizacion": 60, "creatividad": 20}},
  {"id": 4, "titulo": "Soltar la carga", "descripcion": "Siente tus hombros completamente libres y livianos en este momento. Visualiza que ya no cargas con esa mochila de peso invisible sobre ti. Libera la rigidez mental acumulada y respira con total soltura.", "vector_necesidades": {"descanso": 90, "movimiento": 60, "risa": 40, "esperanza": 80, "organizacion": 30}},
  {"id": 5, "titulo": "El reset del agua", "descripcion": "Toma un trago pequeño y pausado de agua fría en este momento. Siente el recorrido exacto del líquido fresco pasar por tu garganta. Es la vida pura ingresando a renovar tu organismo por completo.", "vector_necesidades": {"agua": 100, "descanso": 70, "silencio": 50, "movimiento": 20, "salud": 80}},
  {"id": 7, "titulo": "El aire de la ventana", "descripcion": "Abre la ventana de tu habitación por completo de inmediato. Deja que el aire fresco te golpee suavemente la cara en este conteo. Siente el mundo exterior y límpiate del encierro de la rutina.", "vector_necesidades": {"aire_fresco": 100, "naturaleza": 80, "contemplacion": 70, "descanso": 60, "movimiento": 30}},
  {"id": 8, "titulo": "Rotación de energía", "descripcion": "Gira suavemente tus muñecas y tus tobillos en círculos pausados. Recuerda que este cuerpo es completamente tuyo y tú gobiernas este motor. Siente cómo la energía natural vuelve a fluir libremente por tu ser.", "vector_necesidades": {"movimiento": 95, "descanso": 60, "juego": 40, "salud": 80, "creatividad": 20}},
  {"id": 9, "titulo": "Anclaje del presente", "descripcion": "Cierra los ojos en total silencio acústico ahora mismo. Piensa detalladamente en una cosa buena y hermosa que tienes en tu vida el día de hoy. Dilo con fuerza en tu mente en calma.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "esperanza": 95, "aprendizaje": 70, "risa": 30}},
  {"id": 11, "titulo": "Pies en la tierra", "descripcion": "Quítate los zapatos ahora mismo, sin prisa alguna. Apoya las plantas de tus pies directo sobre el piso frío de la habitación. Siente la firmeza del suelo debajo de ti y conéctate.", "vector_necesidades": {"naturaleza": 90, "movimiento": 70, "contemplacion": 80, "silencio": 60, "descanso": 70}},
  {"id": 12, "titulo": "Estiramiento al cielo", "descripcion": "Estira tu brazo firmemente hacia arriba e intenta tocar el techo con la punta de tus dedos. Mantén la tensión muscular por un segundo exacto en este conteo. Ahora suelta todo de golpe.", "vector_necesidades": {"movimiento": 95, "descanso": 60, "salud": 80, "creatividad": 30, "juego": 20}},
  {"id": 14, "titulo": "Columna recta", "descripcion": "Endereza la espalda por completo en este mismo instante. Un hilo invisible tira suavemente de tu cabeza hacia el cielo. Siente cómo tu pecho se abre libremente y habita tu respiración profunda ahora.", "vector_necesidades": {"salud": 90, "movimiento": 70, "descanso": 80, "silencio": 60, "contemplacion": 70}},
  {"id": 15, "titulo": "Contacto frío", "descripcion": "Busca un objeto o superficie que esté fría al tacto en tu habitación y pon tu mano encima. Siente la temperatura real por unos segundos. Esto te ayuda a calmar la mente de inmediato en tu hogar.", "vector_necesidades": {"naturaleza": 80, "silencio": 70, "contemplacion": 90, "descanso": 60, "movimiento": 20}},
  {"id": 16, "titulo": "Ventilación total", "descripcion": "Abre la ventana más cercana de tu habitación actual. Deja que el aire nuevo entre y ruede por todo el espacio disponible. Respira despacio y nota cómo cambia el ambiente de tu casa con tranquilidad.", "vector_necesidades": {"aire_fresco": 100, "naturaleza": 90, "creatividad": 70, "contemplacion": 80, "movimiento": 40}},
  {"id": 17, "titulo": "Sacudida de estrés", "descripcion": "Ponte de pie con cuidado en tu espacio seguro. Sacude tus manos y tus piernas de forma suave como si te estuvieras quitando gotitas de agua. Haz este movimiento alegre por diez segundos en casa.", "vector_necesidades": {"movimiento": 100, "risa": 80, "descanso": 70, "juego": 60, "esperanza": 70}},
  {"id": 18, "titulo": "Mirada lejana", "descripcion": "Mira a través de la ventana y busca el objeto o la casa que esté más lejos de ti. Quédate observando ese punto fijo para que tus ojos descansen de las pantallas en completa paz.", "vector_necesidades": {"contemplacion": 95, "silencio": 85, "naturaleza": 70, "descanso": 80, "creatividad": 40}},
  {"id": 19, "titulo": "Memoria feliz", "descripcion": "Cierra tus ojos con suavidad por un momento en tu rincón cómodo. Trae a tu mente un recuerdo hermoso e inocente de cuando eras niño. Siente la paz que te da ese lindo día.", "vector_necesidades": {"esperanza": 90, "contemplacion": 95, "risa": 70, "silencio": 80, "descanso": 85}},
  {"id": 20, "titulo": "Sonrisa forzada", "descripcion": "Dibuja una sonrisa grande en tu rostro y mantenla fija durante quince segundos completos en este momento. Este pequeño gesto le avisa a tu mente que es momento de estar en total bienestar.", "vector_necesidades": {"risa": 100, "esperanza": 90, "juego": 70, "creatividad": 50, "salud": 80}},
  {"id": 21, "titulo": "Agradecimiento", "descripcion": "Cierra tus ojos en completo silencio en tu sala. Piensa detenidamente en una sola cosa buena y bonita que te haya pasado durante esta semana y da las gracias en tu mente en calma.", "vector_necesidades": {"esperanza": 100, "contemplacion": 90, "silencio": 80, "descanso": 70, "comunidad": 60}},
  {"id": 22, "titulo": "Relaxa ojos", "descripcion": "Frota las palmas de tus manos para entibiar la piel de inmediato. Colócalas suavemente sobre tus ojos cerrados y disfruta de un minuto completo de oscuridad y descanso total en tu habitación.", "vector_necesidades": {"descanso": 100, "silencio": 90, "contemplacion": 80, "salud": 70, "naturaleza": 20}},
  {"id": 23, "titulo": "Ritmo cardíaco", "descripcion": "Coloca tu mano derecha en el centro de tu pecho con tranquilidad. Siente el latido constante y tranquilo de tu corazón. Recuerda que este es el motor hermoso de tu vida ahora.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "descanso": 80, "salud": 70, "movimiento": 10}},
  {"id": 24, "titulo": "Suelta cuello", "descripcion": "Mueve tu cabeza dibujando círculos muy lentos y suaves en el aire. Siente cómo se va toda la tensión acumulada en tu cuello por culpa de mirar el teléfono en tu hogar.", "vector_necesidades": {"movimiento": 80, "descanso": 90, "salud": 90, "silencio": 70, "organizacion": 30}},
  {"id": 25, "titulo": "Ejercicio de palmas", "descripcion": "Frota tus manos con energía hasta que sientas el calorcito en la piel. Coloca de inmediato tus palmas sobre tus hombros para regalarte un abrazo reconfortante en este momento presente.", "vector_necesidades": {"movimiento": 70, "descanso": 80, "salud": 85, "silencio": 60, "contemplacion": 50}},
  {"id": 26, "titulo": "Sonidos lejanos", "descripcion": "Quédate quieto por unos momentos en tu sala y presta mucha atención al entorno. Intenta identificar el sonido más lejano que se escuche afuera de tu casa en este instante de paz.", "vector_necesidades": {"silencio": 90, "contemplacion": 95, "naturaleza": 80, "aprendizaje": 70, "descanso": 70}},
  {"id": 27, "titulo": "Estiramiento lateral", "descripcion": "Inclina tu cuerpo de forma muy suave hacia el lado derecho y luego hacia el izquierdo con calma. Siente cómo se estira tu cintura con total comodidad y ligereza dentro de tu habitación.", "vector_necesidades": {"movimiento": 90, "salud": 85, "descanso": 70, "organizacion": 40, "silencio": 50}},
  {"id": 28, "titulo": "El vaso vacío", "descripcion": "Busca un vaso transparente en tu cocina. Observa su forma y cómo le entra la luz durante un minuto completo. Nota los hermosos reflejos en absoluto silencio y despeja tu mente.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "creatividad": 60, "aprendizaje": 50, "descanso": 70}},
  {"id": 29, "titulo": "Suelta mandíbula", "descripcion": "Abre grande tu boca con cuidado en tu rincón cómodo. Mueve tu mandíbula despacio de un lado al otro. Siente cómo se libera toda la rigidez y la tensión acumulada del rostro.", "vector_necesidades": {"movimiento": 80, "salud": 90, "risa": 70, "descanso": 80, "silencio": 60}},
  {"id": 30, "titulo": "Pasos lentos", "descripcion": "Ponte de pie con suavidad en tu espacio seguro. Da diez pasos muy lentos y tranquilos dentro de tu habitación actual. Siente el apoyo completo de cada pie al caminar con calma.", "vector_necesidades": {"movimiento": 70, "contemplacion": 80, "silencio": 75, "descanso": 70, "organizacion": 60}},
  {"id": 31, "titulo": "Masaje suave", "descripcion": "Coloca las yemas de tus dedos sobre tus sienes ahora mismo. Dibuja círculos muy lentos y tiernos sin presionar fuerte. Siente el alivio inmediato en tu cabeza y relaja tus pensamientos.", "vector_necesidades": {"descanso": 100, "salud": 90, "silencio": 85, "contemplacion": 70, "movimiento": 20}},
  {"id": 32, "titulo": "Conciencia aire", "descripcion": "Presta atención a tu nariz en este momento. Siente el aire fresco que entra al tomar aire y el aire tibio que sale al soltarlo. Hazlo de forma natural en tu espacio.", "vector_necesidades": {"aire_fresco": 100, "silencio": 90, "contemplacion": 95, "descanso": 80, "naturaleza": 70}},
  {"id": 33, "titulo": "Espalda firme", "descripcion": "Lleva tus hombros suavemente hacia atrás y abre tu pecho con ligereza en este instante. Siente cómo tu cuerpo recupera su postura natural, recta y cómoda dentro de tu casa.", "vector_necesidades": {"movimiento": 85, "salud": 90, "organizacion": 70, "descanso": 70, "esperanza": 60}},
  {"id": 34, "titulo": "Apoyo total", "descripcion": "Toma asiento con tranquilidad y relaja tu espalda. Siente cómo la silla sostiene todo el peso de tu cuerpo con total seguridad. Suelta los músculos ahora y descansa de verdad.", "vector_necesidades": {"descanso": 95, "contemplacion": 90, "silencio": 80, "naturaleza": 40, "movimiento": 10}},
  {"id": 35, "titulo": "Cuenta atrás", "descripcion": "Cuenta los números al revés, comenzando desde el veinte hasta llegar al uno. Hazlo de forma muy pausada en tu mente para calmar todos tus pensamientos y encontrar total paz.", "vector_necesidades": {"organizacion": 100, "aprendizaje": 80, "silencio": 90, "contemplacion": 95, "descanso": 70}},
  {"id": 36, "titulo": "Toca textura", "descripcion": "Pasa las yemas de tus dedos sobre una superficie real que tengas cerca, como una mesa de madera o una prenda de tela limpia. Nota su textura con absoluta calma.", "vector_necesidades": {"contemplacion": 90, "creatividad": 70, "aprendizaje": 60, "naturaleza": 50, "silencio": 70}},
  {"id": 37, "titulo": "Estira dedos", "descripcion": "Separa y estira los dedos de tus manos lo más que puedas durante cinco segundos enteros. Después, relájalos por completo para que descansen de las pantallas en este instante.", "vector_necesidades": {"movimiento": 90, "salud": 80, "descanso": 70, "juego": 40, "organizacion": 30}},
  {"id": 38, "titulo": "Sonido interno", "descripcion": "Quédate en silencio en tu rincón cómodo y escucha el sonido suave de tu propia respiración. No intentes forzarla ni cambiarla, solo nota cómo tu cuerpo respira solo.", "vector_necesidades": {"silencio": 100, "contemplacion": 95, "descanso": 90, "salud": 85, "naturaleza": 60}},
  {"id": 39, "titulo": "Mirada fija", "descripcion": "Busca un punto pequeño o una marca en la pared frente a ti. Quédate mirando ese lugar fijo con tranquilidad, permitiendo que tus ojos se enfoquen lejos de las pantallas.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "organizacion": 80, "aprendizaje": 70, "descanso": 75}},
  {"id": 40, "titulo": "Suelta brazos", "descripcion": "Deja colgar tus brazos con total flojedad a los lados de tu cuerpo en tu sala. Sacúdelos de forma muy suave para eliminar cualquier rastro de pesadez acumulada.", "vector_necesidades": {"movimiento": 95, "descanso": 80, "salud": 85, "risa": 60, "juego": 50}},
  {"id": 41, "titulo": "Contacto ropa", "descripcion": "Cierra tus ojos un instante en tu asiento. Intenta notar la sensación sutil y el peso suave de la ropa descansando sobre la piel de tus hombros y tus brazos.", "vector_necesidades": {"contemplacion": 90, "silencio": 80, "descanso": 70, "naturaleza": 30, "movimiento": 10}},
  {"id": 42, "titulo": "Aire profundo", "descripcion": "Toma aire despacio inflando tu vientre en tu espacio seguro, mantén el aire guardado por tres segundos y luego suéltalo muy suavemente por la boca con calma.", "vector_necesidades": {"silencio": 100, "descanso": 95, "salud": 90, "aire_fresco": 80, "contemplacion": 90}},
  {"id": 43, "titulo": "Rotación hombros", "descripcion": "Sube tus hombros despacio como si quisieras tocar tus orejas, mantén la fuerza un momento y déjalos caer de golpe para soltar la carga del día en tu casa.", "vector_necesidades": {"movimiento": 90, "salud": 85, "descanso": 80, "risa": 50, "organizacion": 40}},
  {"id": 44, "titulo": "Escucha silencio", "descripcion": "Quédate en completa calma por unos momentos en tu habitación e intenta escuchar el pequeño espacio de silencio que ocurre entre cada respiración natural en paz.", "vector_necesidades": {"silencio": 100, "contemplacion": 95, "descanso": 90, "aprendizaje": 80, "naturaleza": 70}},
  {"id": 45, "titulo": "Mirada techo", "descripcion": "Mira hacia arriba en dirección al techo con suavidad en tu asiento. Estira tu cuello con total comodidad sin levantar ni mover tus hombros para nada.", "vector_necesidades": {"movimiento": 70, "descanso": 80, "salud": 80, "contemplacion": 70, "silencio": 60}},
  {"id": 46, "titulo": "Siente base", "descripcion": "Presta atención a la parte de atrás de tus piernas ahora mismo. Nota el contacto firme y seguro que hacen contra el asiento de tu silla en tu comedor.", "vector_necesidades": {"descanso": 90, "contemplacion": 85, "silencio": 75, "naturaleza": 40, "movimiento": 20}},
  {"id": 48, "titulo": "Limpieza mental", "descripcion": "Imagina que al soltar el aire sacas de tu cuerpo cualquier preocupación aburrida y pesada en tu hogar, dejándola fuera de ti por completo en este segundo.", "vector_necesidades": {"esperanza": 90, "silencio": 80, "descanso": 85, "risa": 50, "creatividad": 60}},
  {"id": 49, "titulo": "Toca mesa", "descripcion": "Apoya las palmas de tus manos abiertas sobre la mesa. Siente la firmeza del mueble de tu casa y conéctate con esa agradable sensación de estabilidad.", "vector_necesidades": {"contemplacion": 90, "organizacion": 80, "silencio": 70, "descanso": 60, "naturaleza": 30}},
  {"id": 50, "titulo": "Presencia total", "descripcion": "Recuerda que estás aquí en este instante, estás completamente a salvo en el cobijo de tu hogar y tienes el control absoluto de tu tranquilidad.", "vector_necesidades": {"esperanza": 100, "contemplacion": 95, "silencio": 90, "descanso": 85, "organizacion": 70}},
  {"id": 51, "titulo": "Canta una melodía", "descripcion": "Tararea tu canción favorita de forma muy suave y bajita en tu habitación. Deja de pensar en tus tareas y simplemente disfruta de la música en paz.", "vector_necesidades": {"musica": 100, "risa": 70, "creatividad": 80, "descanso": 60, "juego": 50}},
  {"id": 52, "titulo": "Escribe 3 deseos", "descripcion": "Toma un papel blanco en tu escritorio y escribe tres cosas sencillas y bonitas que te gustaría cumplir o disfrutar durante las horas de hoy con calma.", "vector_necesidades": {"creatividad": 90, "aprendizaje": 70, "organizacion": 80, "esperanza": 95, "contemplacion": 70}},
  {"id": 53, "titulo": "Paseo por el pasillo", "descripcion": "Camina lentamente y con pasos muy suaves a lo largo del pasillo de tu casa, prestando atención a cómo apoyas cada pie al andar.", "vector_necesidades": {"movimiento": 70, "contemplacion": 80, "silencio": 70, "descanso": 60, "organizacion": 50}},
  {"id": 54, "titulo": "Mira una planta", "descripcion": "Busca una planta o una hojita verde que tengas cerca en tu sala. Observa sus colores y sus formas detalladamente durante un minuto en silencio.", "vector_necesidades": {"naturaleza": 90, "contemplacion": 95, "silencio": 80, "descanso": 70, "aprendizaje": 60}},
  {"id": 55, "titulo": "Dibuja un círculo", "descripcion": "Toma un lápiz y dibuja círculos redondos en una hoja de papel de forma muy tranquila, concentrándote solo en el trazo de tu mano en casa.", "vector_necesidades": {"creatividad": 100, "juego": 80, "contemplacion": 70, "silencio": 60, "descanso": 50}},
  {"id": 57, "titulo": "Abre un libro al azar", "descripcion": "Toma un libro que tengas cerca en tu estante, abre una página cualquiera sin mirar y lee con atención la primera frase que encuentren tus ojos.", "vector_necesidades": {"aprendizaje": 90, "creatividad": 70, "contemplacion": 80, "silencio": 70, "descanso": 60}},
  {"id": 58, "titulo": "Escucha la lluvia", "descripcion": "Abre tu ventana con cuidado y escucha el sonido tranquilo de las gotas al caer contra el suelo o las superficies por un momento en paz.", "vector_necesidades": {"naturaleza": 100, "silencio": 95, "agua": 90, "contemplacion": 90, "descanso": 85}},
  {"id": 59, "titulo": "Baila sin música", "descripcion": "Ponte de pie en tu habitación y mueve tu cuerpo libremente durante un minuto completo. Hazlo con alegría y soltura, como si nadie te estuviera viendo.", "vector_necesidades": {"movimiento": 100, "juego": 90, "risa": 80, "creatividad": 70, "musica": 50}},
  {"id": 60, "titulo": "Bebe una infusión", "descripcion": "Prepara una tacita de té o una infusión caliente en tu cocina. Dale pequeños sorbos muy despacio, sintiendo el calorcito reconfortante que entra a tu cuerpo.", "vector_necesidades": {"alimentacion": 90, "descanso": 100, "silencio": 80, "salud": 70, "contemplacion": 70}},
  {"id": 61, "titulo": "Mira tus manos", "descripcion": "Extiende tus manos frente a ti en tu asiento. Observa detenidamente cada una de las líneas, los dedos y los pequeños detalles de tu piel humana.", "vector_necesidades": {"contemplacion": 95, "aprendizaje": 70, "silencio": 80, "esperanza": 60, "creatividad": 50}},
  {"id": 62, "titulo": "Imagina un paisaje", "descripcion": "Cierra tus ojos suavemente en tu sofá. Imagina que estás caminando por tu lugar de la naturaleza favorito, como un bosque o una playa tranquila hoy.", "vector_necesidades": {"naturaleza": 100, "contemplacion": 95, "silencio": 90, "descanso": 85, "creatividad": 80}},
  {"id": 63, "titulo": "Estira la espalda", "descripcion": "Siéntate en el suelo de tu sala con tus piernas bien estiradas hacia el frente. Lleva tus manos despacio hacia adelante e intenta tocar tus pies.", "vector_necesidades": {"movimiento": 90, "salud": 85, "descanso": 70, "organizacion": 40, "silencio": 50}},
  {"id": 64, "titulo": "Respira por la nariz", "descripcion": "Toma aire de forma muy profunda y lenta utilizando únicamente tu nariz en tu silla. Siente cómo entra el aire fresco y hazlo cinco veces seguidas para darte calma.", "vector_necesidades": {"silencio": 100, "descanso": 95, "salud": 90, "aire_fresco": 80, "contemplacion": 90}},
  {"id": 65, "titulo": "Juego de sombras", "descripcion": "Enciende una lámpara pequeña frente a una pared limpia de tu habitación. Usa tus manos y tus dedos para inventar formas divertidas de animalitos usando las sombras de la luz.", "vector_necesidades": {"juego": 100, "creatividad": 90, "risa": 70, "contemplacion": 60, "descanso": 50}},
  {"id": 66, "titulo": "Un abrazo imaginario", "descripcion": "Cruza tus brazos sobre tu pecho en tu sofá y apriétate a ti mismo con fuerza. Imagina con mucho cariño que estás recibiendo un lindo abrazo de un ser muy querido.", "vector_necesidades": {"comunidad": 90, "esperanza": 80, "descanso": 70, "risa": 60, "silencio": 50}},
  {"id": 67, "titulo": "Encuentra un objeto azul", "descripcion": "Mira a tu alrededor rápidamente dentro de tu sala. Intenta descubrir cinco objetos diferentes que sean de color azul para entrenar tu atención con total tranquilidad hoy.", "vector_necesidades": {"organizacion": 80, "aprendizaje": 70, "juego": 60, "creatividad": 50, "contemplacion": 70}},
  {"id": 69, "titulo": "Observa el cielo", "descripcion": "Asómate a la ventana de tu cuarto un momento. Levanta la mirada con calma hacia el horizonte exterior y quédate observando el cielo despejado durante un minuto entero.", "vector_necesidades": {"naturaleza": 95, "contemplacion": 100, "aire_fresco": 90, "silencio": 80, "descanso": 70}},
  {"id": 70, "titulo": "Masaje facial", "descripcion": "Usa las yemas de tus dedos para darte un masaje muy suave en el rostro frente al espejo. Dibuja círculos tranquilos por tu frente, tus mejillas y tu mandíbula en silencio.", "vector_necesidades": {"descanso": 100, "salud": 90, "silencio": 85, "movimiento": 50, "contemplacion": 70}},
  {"id": 71, "titulo": "Cierra los ojos y escucha", "descripcion": "Toma una postura muy cómoda en tu asiento de descanso y cierra los ojos con suavidad. Presta mucha atención e intenta identificar tres sonidos diferentes dentro de casa.", "vector_necesidades": {"silencio": 100, "contemplacion": 95, "descanso": 90, "aprendizaje": 70, "naturaleza": 60}},
  {"id": 72, "titulo": "Tensa y relaja los pies", "descripcion": "Aprieta con fuerza los dedos de tus dos pies hacia adentro en tu alfombra durante cinco segundos enteros para acumular tensión. Después, suéltalos de golpe para que descansen.", "vector_necesidades": {"movimiento": 90, "descanso": 80, "salud": 70, "organizacion": 40, "silencio": 50}},
  {"id": 74, "titulo": "Olor consciente", "descripcion": "Busca algo en tu alacena que tenga un aroma agradable que te guste mucho, como un granito de café o una especia. Acércalo a tu nariz y concéntrate en su olor.", "vector_necesidades": {"naturaleza": 80, "alimentacion": 70, "contemplacion": 90, "silencio": 80, "descanso": 70}},
  {"id": 75, "titulo": "Copia un dibujo simple", "descripcion": "Busca un dibujo pequeño y muy sencillo en una revista o un libro de tu mesa. Toma un lápiz e intenta copiar sus líneas en una hoja de papel de forma tranquila.", "vector_necesidades": {"creatividad": 100, "juego": 80, "contemplacion": 70, "silencio": 60, "descanso": 50}},
  {"id": 76, "titulo": "Encuentra tres objetos rojos", "descripcion": "Mira a tu alrededor velozmente dentro de tu habitación actual. Intenta descubrir tres objetos diferentes que sean de color rojo para activar tu enfoque consciente en total calma.", "vector_necesidades": {"organizacion": 80, "aprendizaje": 70, "juego": 60, "creatividad": 50, "contemplacion": 70}},
  {"id": 78, "titulo": "Escribe una palabra bonita", "descripcion": "Toma un bolígrafo y escribe una palabra hermosa que te guste mucho en un papel limpio, como Paz o Calma. Dibuja letras grandes y ordenadas en tu escritorio.", "vector_necesidades": {"creatividad": 90, "aprendizaje": 70, "organizacion": 80, "esperanza": 100, "contemplacion": 60}},
  {"id": 79, "titulo": "Masaje en las manos", "descripcion": "Usa el dedo pulgar de tu mano derecha para dar un masaje suave en la palma de tu mano izquierda. Dibuja círculos lentos por toda la piel con mucha ternura en tu asiento.", "vector_necesidades": {"descanso": 100, "salud": 90, "silencio": 85, "movimiento": 30, "contemplacion": 60}},
  {"id": 81, "titulo": "Estiramiento de cuello lateral", "descripcion": "Inclina tu cabeza despacio llevando tu oreja derecha hacia el hombro derecho sin levantar los hombros. Mantén la postura tres segundos y cambia de lado con suavidad en tu sofá.", "vector_necesidades": {"movimiento": 85, "salud": 90, "descanso": 80, "silencio": 70, "organizacion": 20}},
  {"id": 82, "titulo": "Observa una sombra", "descripcion": "Busca una sombra proyectada en el piso o en la pared de tu habitación actual. Observa detalladamente sus bordes oscuros y sus formas en silencio por un minuto entero.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "creatividad": 50, "descanso": 75, "naturaleza": 20}},
  {"id": 83, "titulo": "Siente tus latidos", "descripcion": "Coloca dos de tus dedos suavemente sobre tu muñeca izquierda o en tu cuello en tu rincón cómodo. Quédate quieto sintiendo el latido constante y fuerte de tu pulso.", "vector_necesidades": {"contemplacion": 100, "silencio": 95, "descanso": 90, "salud": 90, "movimiento": 10}},
  {"id": 159, "titulo": "EL RETO DE LA RESPIRACIÓN", "descripcion": "Quédate sentado en una postura muy cómoda en tu sala. Haz cinco respiraciones profundas y lentas por la nariz, sintiendo cómo entra el aire puro a tu cuerpo. Nada más.", "vector_necesidades": {"silencio": 100, "descanso": 95, "salud": 90, "contemplacion": 90, "aire_fresco": 80}},
  {"id": 160, "titulo": "EL RETO DEL DESCANSO VISUAL", "descripcion": "Busca un punto u objeto que esté muy lejano a ti a través de la ventana de tu cuarto. Quédate mirando ese lugar fijamente durante dos minutos para descansar tus ojos de las pantallas.", "vector_necesidades": {"contemplacion": 95, "silencio": 85, "descanso": 90, "naturaleza": 70, "salud": 80}}
   ],
    "CASA_EN": [
  {"id": 1, "titulo": "Break the autopilot", "descripcion": "Take a brief moment to scan your body completely. Locate the exact weight built up on your upper back and observe it with absolute calm. Feel your heartbeat and remember that you are alive in this peaceful second.", "vector_necesidades": {"contemplacion": 90, "descanso": 80, "silencio": 70, "organizacion": 50, "movimiento": 30}},
  {"id": 2, "titulo": "Total disconnection", "descripcion": "Feel the shape of the chair beneath your body right now. The firm floor supports your entire weight completely for free and safely. Do not fight it, let yourself fall into total calm at this instant.", "vector_necesidades": {"descanso": 90, "contemplacion": 80, "silencio": 70, "organizacion": 40, "esperanza": 60}},
  {"id": 3, "titulo": "Screen isolation", "descripcion": "Turn your cell phone face down with total peace of mind at this instant. Stare closely at a corner of the ceiling for thirty straight seconds and allow your mind to break the loop of digital rush now.", "vector_necesidades": {"silencio": 95, "descanso": 85, "contemplacion": 90, "organizacion": 60, "creatividad": 20}},
  {"id": 4, "titulo": "Let go of the load", "descripcion": "Feel your shoulders completely free and lightweight right now. Imagine that you no longer carry that heavy invisible backpack on you. Let go of all accumulated mental stiffness and breathe with complete ease.", "vector_necesidades": {"descanso": 90, "movimiento": 60, "risa": 40, "esperanza": 80, "organizacion": 30}},
  {"id": 5, "titulo": "The water reset", "descripcion": "Take a small, unhurried sip of cold water at this moment. Feel the exact path of the fresh liquid passing down your throat. It is pure life entering to fully renew your entire organism completely.", "vector_necesidades": {"agua": 100, "descanso": 70, "silencio": 50, "movimiento": 20, "salud": 80}},
  {"id": 7, "titulo": "Window breeze", "descripcion": "Open your room's window completely right now. Let the fresh outdoor air gently touch your face during this count. Feel the outside world and clear your mind from all the confinement of routine.", "vector_necesidades": {"aire_fresco": 100, "naturaleza": 80, "contemplacion": 70, "descanso": 60, "movimiento": 30}},
  ...
  {"id": 14, "titulo": "Straight spine", "descripcion": "Straighten your back completely at this very moment. An invisible string gently pulls your head toward the sky. Feel how your chest opens freely and inhabit your deep and peaceful breathing now.", "vector_necesidades": {"salud": 90, "movimiento": 70, "descanso": 80, "silencio": 60, "contemplacion": 70}},
  {"id": 15, "titulo": "Cold touch", "descripcion": "Look for an object or surface that is cold to the touch in your room and place your hand on it. Feel the real temperature for a few seconds. This helps calm your mind immediately at home.", "vector_necesidades": {"naturaleza": 80, "silencio": 70, "contemplacion": 90, "descanso": 60, "movimiento": 20}},
  {"id": 16, "titulo": "Total ventilation", "descripcion": "Open the nearest window in your current room. Let the new air enter and roll through the entire available space. Breathe slowly and notice how your home's environment changes peacefully.", "vector_necesidades": {"aire_fresco": 100, "naturaleza": 90, "creatividad": 70, "contemplacion": 80, "movimiento": 40}},
  {"id": 17, "titulo": "Stress shake", "descripcion": "Stand up carefully in your safe space. Shake your hands and legs gently as if you were shaking off small drops of water. Do this cheerful movement for ten seconds at home.", "vector_necesidades": {"movimiento": 100, "risa": 80, "descanso": 70, "juego": 60, "esperanza": 70}},
  {"id": 18, "titulo": "Distant gaze", "descripcion": "Look through the window and find the object or house that is furthest away from you. Keep observing that fixed point to rest your eyes from screens in complete and deep peace.", "vector_necesidades": {"contemplacion": 95, "silencio": 85, "naturaleza": 70, "descanso": 80, "creatividad": 40}},
  {"id": 19, "titulo": "Happy memory", "descripcion": "Close your eyes gently for a moment in your cozy corner. Bring to your mind a beautiful and innocent memory from when you were a child. Feel the peace that pretty day gives you.", "vector_necesidades": {"esperanza": 90, "contemplacion": 95, "risa": 70, "silencio": 80, "descanso": 85}},
  {"id": 20, "titulo": "Forced smile", "descripcion": "Draw a big smile on your face and keep it fixed for fifteen full seconds at this moment. This small gesture lets your mind know it is time to be in total well-being.", "vector_necesidades": {"risa": 100, "esperanza": 90, "juego": 70, "creatividad": 50, "salud": 80}},
  {"id": 21, "titulo": "Gratitude", "descripcion": "Close your eyes in complete silence in your living room. Think carefully about a single good and beautiful thing that has happened to you this week and give thanks in your calm mind.", "vector_necesidades": {"esperanza": 100, "contemplacion": 90, "silencio": 80, "descanso": 70, "comunidad": 60}},
  {"id": 22, "titulo": "Eye relax", "descripcion": "Rub the palms of your hands to warm the skin immediately. Place them gently over your closed eyes and enjoy a full minute of darkness and total rest inside your quiet room.", "vector_necesidades": {"descanso": 100, "silencio": 90, "contemplacion": 80, "salud": 70, "naturaleza": 20}},
  {"id": 23, "titulo": "Heart rate", "descripcion": "Place your right hand in the center of your chest peacefully. Feel the steady and peaceful beat of your heart. Remember that this is the beautiful engine of your life now.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "descanso": 80, "salud": 70, "movimiento": 10}},
  {"id": 24, "titulo": "Neck release", "descripcion": "Move your head drawing very slow and gentle circles in the air. Feel how all the tension built up in your neck from looking at the phone goes away inside your home.", "vector_necesidades": {"movimiento": 80, "descanso": 90, "salud": 90, "silencio": 70, "organizacion": 30}},
  {"id": 25, "titulo": "Palm exercise", "descripcion": "Rub your hands with energy until you feel the warmth on your skin. Immediately place your palms on your shoulders to give yourself a comforting hug at this exact present moment.", "vector_necesidades": {"movimiento": 70, "descanso": 80, "salud": 85, "silencio": 60, "contemplacion": 50}},
  {"id": 26, "titulo": "Distant sounds", "descripcion": "Stay still for a few moments in your living room and pay close attention to your surroundings. Try to identify the furthest sound that can be heard outside your house in this peaceful instant.", "vector_necesidades": {"silencio": 90, "contemplacion": 95, "naturaleza": 80, "aprendizaje": 70, "descanso": 70}},
  {"id": 27, "titulo": "Lateral stretch", "descripcion": "Tilt your body very gently to the right side and then to the left with complete calm. Feel how your waist stretches with total comfort and muscular lightness inside your room.", "vector_necesidades": {"movimiento": 90, "salud": 85, "descanso": 70, "organizacion": 40, "silencio": 50}},
  {"id": 28, "titulo": "The empty glass", "descripcion": "Look for a clear glass in your kitchen. Observe its shape and how the light enters it for one full minute. Notice the beautiful reflections in absolute silence and clear your mind.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "creatividad": 60, "aprendizaje": 50, "descanso": 70}},
  {"id": 29, "titulo": "Jaw release", "descripcion": "Open your mouth wide carefully in your cozy corner. Move your jaw slowly from one side to the other. Feel how all the stiffness and accumulated tension leaves your face.", "vector_necesidades": {"movimiento": 80, "salud": 90, "risa": 70, "descanso": 80, "silencio": 60}},
  {"id": 30, "titulo": "Slow steps", "descripcion": "Stand up gently in your safe space. Take ten very slow and quiet steps inside your current room. Feel the full support of each foot as you walk with calm.", "vector_necesidades": {"movimiento": 70, "contemplacion": 80, "silencio": 75, "descanso": 70, "organizacion": 60}},
  {"id": 31, "titulo": "Gentle massage", "descripcion": "Place your fingertips on your temples right now. Draw very slow and tender circles without pressing hard. Feel the immediate relief in your head and relax your thoughts.", "vector_necesidades": {"descanso": 100, "salud": 90, "silencio": 85, "contemplacion": 70, "movimiento": 20}},
  {"id": 32, "titulo": "Air awareness", "descripcion": "Pay attention to your nose at this moment. Feel the fresh air coming in as you breathe in and the warm air coming out as you let it go. Do it naturally in your space.", "vector_necesidades": {"aire_fresco": 100, "silencio": 90, "contemplacion": 95, "descanso": 80, "naturaleza": 70}},
  {"id": 33, "titulo": "Firm back", "descripcion": "Bring your shoulders gently back and open your chest lightly at this instant. Feel how your body recovers its natural, straight and comfortable posture inside your house.", "vector_necesidades": {"movimiento": 85, "salud": 90, "organizacion": 70, "descanso": 70, "esperanza": 60}},
  {"id": 34, "titulo": "Total support", "descripcion": "Take a seat quietly and relax your back. Feel how the chair holds all the weight of your body with total safety. Release your muscles now and truly rest.", "vector_necesidades": {"descanso": 95, "contemplacion": 90, "silencio": 80, "naturaleza": 40, "movimiento": 10}},
  {"id": 35, "titulo": "Countdown", "descripcion": "Count the numbers backwards, starting from twenty until you reach one. Do it very slowly in your mind to calm all your thoughts and find absolute peace.", "vector_necesidades": {"organizacion": 100, "aprendizaje": 80, "silencio": 90, "contemplacion": 95, "descanso": 70}},
  {"id": 36, "titulo": "Touch texture", "descripcion": "Pass your fingertips over a real surface nearby, such as a wooden table or a piece of clean cloth. Notice its texture with absolute calm.", "vector_necesidades": {"contemplacion": 90, "creatividad": 70, "aprendizaje": 60, "naturaleza": 50, "silencio": 70}},
  {"id": 37, "titulo": "Stretch fingers", "descripcion": "Separate and stretch your fingers as much as you can for five whole seconds with energy. Afterwards, relax them completely so they can rest from screens at this instant.", "vector_necesidades": {"movimiento": 90, "salud": 80, "descanso": 70, "juego": 40, "organizacion": 30}},
  {"id": 38, "titulo": "Internal sound", "descripcion": "Stay in silence in your cozy corner and listen to the soft sound of your own breathing. Do not try to force it or change it, just notice how your body breathes on its own.", "vector_necesidades": {"silencio": 100, "contemplacion": 95, "descanso": 90, "salud": 85, "naturaleza": 60}},
  {"id": 39, "titulo": "Fixed gaze", "descripcion": "Look for a small spot or a mark on the wall in front of you. Keep looking at that fixed place peacefully, allowing your eyes to focus far away from the screens.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "organizacion": 80, "aprendizaje": 70, "descanso": 75}},
  {"id": 40, "titulo": "Drop arms", "descripcion": "Let your arms hang completely loose at the sides of your body in your living room. Shake them very gently to remove any trace of accumulated heaviness.", "vector_necesidades": {"movimiento": 95, "descanso": 80, "salud": 85, "risa": 60, "juego": 50}},
  {"id": 41, "titulo": "Clothing contact", "descripcion": "Close your eyes for a moment in your seat. Try to notice the subtle sensation and smooth weight of your clothes resting on the skin of your shoulders and arms.", "vector_necesidades": {"contemplacion": 90, "silencio": 80, "descanso": 70, "naturaleza": 30, "movimiento": 10}},
  {"id": 42, "titulo": "Deep air", "descripcion": "Breathe in slowly inflating your belly in your safe space, hold the air for three seconds, and then release it very gently through your mouth with calm.", "vector_necesidades": {"silencio": 100, "descanso": 95, "salud": 90, "aire_fresco": 80, "contemplacion": 90}},
  {"id": 43, "titulo": "Shoulder rotation", "descripcion": "Raise your shoulders slowly as if you wanted to touch your ears, hold the strength for a moment, and let them drop suddenly to release the day's load in your house.", "vector_necesidades": {"movimiento": 90, "salud": 85, "descanso": 80, "risa": 50, "organizacion": 40}},
  {"id": 44, "titulo": "Listen to silence", "descripcion": "Stay in complete calm for a few moments in your room and try to listen to the small space of silence that happens between each natural breath in peace.", "vector_necesidades": {"silencio": 100, "contemplacion": 95, "descanso": 90, "aprendizaje": 80, "naturaleza": 70}},
  {"id": 45, "titulo": "Ceiling gaze", "descripcion": "Look up toward the ceiling gently in your seat. Stretch your neck with total comfort without lifting or moving your shoulders at all.", "vector_necesidades": {"movimiento": 70, "descanso": 80, "salud": 80, "contemplacion": 70, "silencio": 60}},
  {"id": 46, "titulo": "Feel the base", "descripcion": "Pay attention to the back of your legs right now. Notice the firm and secure contact they make against the seat of your chair in your dining room.", "vector_necesidades": {"descanso": 90, "contemplacion": 85, "silencio": 75, "naturaleza": 40, "movimiento": 20}},
  {"id": 48, "titulo": "Mental cleansing", "descripcion": "Imagine that as you release your breath you take out from your body any boring and heavy worry in your home, leaving it completely outside of you in this second.", "vector_necesidades": {"esperanza": 90, "silencio": 80, "descanso": 85, "risa": 50, "creatividad": 60}},
  {"id": 49, "titulo": "Touch the table", "descripcion": "Place the palms of your open hands on the table. Feel the firmness of the piece of furniture of your house and connect with that feeling of stability.", "vector_necesidades": {"contemplacion": 90, "organizacion": 80, "silencio": 70, "descanso": 60, "naturaleza": 30}},
  {"id": 50, "titulo": "Total presence", "descripcion": "Remember that you are here at this moment, you are completely safe in the shelter of your home, and you have control of your tranquility.", "vector_necesidades": {"esperanza": 100, "contemplacion": 95, "silencio": 90, "descanso": 85, "organizacion": 70}},
  {"id": 51, "titulo": "Sing a melody", "descripcion": "Hum your favorite song very softly and quietly in your room. Stop thinking about your tasks and simply enjoy the music in absolute peace.", "vector_necesidades": {"musica": 100, "risa": 70, "creatividad": 80, "descanso": 60, "juego": 50}},
  {"id": 52, "titulo": "Write 3 wishes", "descripcion": "Take a white piece of paper at your desk and write down three simple and beautiful things you would like to fulfill or enjoy during the hours of today calmly.", "vector_necesidades": {"creatividad": 90, "aprendizaje": 70, "organizacion": 80, "esperanza": 95, "contemplacion": 70}},
  {"id": 53, "titulo": "Hallway stroll", "descripcion": "Walk slowly and with very soft steps along the hallway of your house, paying close attention to how you support each foot as you move along.", "vector_necesidades": {"movimiento": 70, "contemplacion": 80, "silencio": 70, "descanso": 60, "organizacion": 50}},
  {"id": 54, "titulo": "Look at a plant", "descripcion": "Look for a plant or a green leaf nearby in your living room. Observe its colors and shapes in close detail for one minute in silence.", "vector_necesidades": {"naturaleza": 90, "contemplacion": 95, "silencio": 80, "descanso": 70, "aprendizaje": 60}},
  {"id": 55, "titulo": "Draw a circle", "descripcion": "Take a pencil and draw round circles on a sheet of paper very quietly, focusing only on the steady stroke of your hand inside your house.", "vector_necesidades": {"creatividad": 100, "juego": 80, "contemplacion": 70, "silencio": 60, "descanso": 50}},
  {"id": 57, "titulo": "Open a book at random", "descripcion": "Take a book nearby from your shelf, open any page without looking, and read carefully the first phrase your eyes find right away.", "vector_necesidades": {"aprendizaje": 90, "creatividad": 70, "contemplacion": 80, "silencio": 70, "descanso": 60}},
  {"id": 58, "titulo": "Listen to the rain", "descripcion": "Open your window carefully and listen to the peaceful sound of the drops falling against the ground or surfaces for a moment in complete quietness.", "vector_necesidades": {"naturaleza": 100, "silencio": 95, "agua": 90, "contemplacion": 90, "descanso": 85}},
  ...
  {"id": 60, "titulo": "Drink a herbal tea", "descripcion": "Prepare a cup of tea or a hot herbal infusion in your kitchen. Take small sips very slowly, feeling the comforting warmth entering your body.", "vector_necesidades": {"alimentacion": 90, "descanso": 100, "silencio": 80, "salud": 70, "contemplacion": 70}},
  {"id": 61, "titulo": "Look at your hands", "descripcion": "Extend your hands in front of you in your seat. Closely observe each of the lines, fingers, and tiny details of your human skin.", "vector_necesidades": {"contemplacion": 95, "aprendizaje": 70, "silencio": 80, "esperanza": 60, "creatividad": 50}},
  {"id": 62, "titulo": "Imagine a landscape", "descripcion": "Close your eyes gently on your couch. Imagine that you are walking through your favorite nature spot, like a forest or a quiet beach today.", "vector_necesidades": {"naturaleza": 100, "contemplacion": 95, "silencio": 90, "descanso": 85, "creatividad": 80}},
  {"id": 63, "titulo": "Stretch your back", "descripcion": "Sit on the floor of your living room with your legs well stretched forward. Slowly bring your hands forward and try to touch your feet.", "vector_necesidades": {"movimiento": 90, "salud": 85, "descanso": 70, "organizacion": 40, "silencio": 50}},
  {"id": 64, "titulo": "Breathe through your nose", "descripcion": "Breathe in very deeply and slowly using only your nose while sitting on your chair. Feel how the fresh air comes in and do it five times in a row to calm yourself.", "vector_necesidades": {"silencio": 100, "descanso": 95, "salud": 90, "aire_fresco": 80, "contemplacion": 90}},
  {"id": 65, "titulo": "Shadow play", "descripcion": "Turn on a small lamp in front of a clean wall in your room. Use your hands and fingers to make up fun little animal shapes using the light shadows beautifully.", "vector_necesidades": {"juego": 100, "creatividad": 90, "risa": 70, "contemplacion": 60, "descanso": 50}},
  {"id": 66, "titulo": "An imaginary hug", "descripcion": "Cross your arms over your chest while sitting on your couch and squeeze yourself tightly. Imagine with much affection that you are receiving a nice hug from a loved one.", "vector_necesidades": {"comunidad": 90, "esperanza": 80, "descanso": 70, "risa": 60, "silencio": 50}},
  {"id": 67, "titulo": "Find a blue object", "descripcion": "Look around you quickly inside your living room. Try to discover five different objects that are blue to train your mindful attention with complete peace of mind today.", "vector_necesidades": {"organizacion": 80, "aprendizaje": 70, "juego": 60, "creatividad": 50, "contemplacion": 70}},
  {"id": 69, "titulo": "Observe the sky", "descripcion": "Look out the window of your room for a moment. Calmly look up toward the outer horizon and stay observing the clear sky for one full minute in peace.", "vector_necesidades": {"naturaleza": 95, "contemplacion": 100, "aire_fresco": 90, "silencio": 80, "descanso": 70}},
  {"id": 70, "titulo": "Facial massage", "descripcion": "Use your fingertips to give yourself a very gentle face massage in front of your mirror. Draw peaceful circles across your forehead, cheeks, and jaw in complete silence.", "vector_necesidades": {"descanso": 100, "salud": 90, "silencio": 85, "movimiento": 50, "contemplacion": 70}},
  {"id": 71, "titulo": "Close your eyes and listen", "descripcion": "Take a very comfortable position in your resting seat and close your eyes gently. Pay close attention and try to identify three different sounds happening inside the house.", "vector_necesidades": {"silencio": 100, "contemplacion": 95, "descanso": 90, "aprendizaje": 70, "naturaleza": 60}},
  {"id": 72, "titulo": "Tense and relax your feet", "descripcion": "Tightly squeeze the toes of both your feet inward on your rug for five full seconds to build up tension. Afterwards, release them all at once to let them rest.", "vector_necesidades": {"movimiento": 90, "descanso": 80, "salud": 70, "organizacion": 40, "silencio": 50}},
  {"id": 74, "titulo": "Mindful scent", "descripcion": "Look for something in your pantry that has a pleasant aroma you like a lot, such as a coffee bean or a spice. Bring it close to your nose and focus.", "vector_necesidades": {"naturaleza": 80, "alimentacion": 70, "contemplacion": 90, "silencio": 80, "descanso": 70}},
  {"id": 75, "titulo": "Copy a simple drawing", "descripcion": "Look for a small and very simple drawing in a magazine or a book on your table. Take a pencil and try to copy its lines on paper peacefully.", "vector_necesidades": {"creatividad": 100, "juego": 80, "contemplacion": 70, "silencio": 60, "descanso": 50}},
  {"id": 76, "titulo": "Find three red objects", "descripcion": "Look around you quickly inside your current room. Try to discover three different objects that are red to activate your mindful focus in total calm today.", "vector_necesidades": {"organizacion": 80, "aprendizaje": 70, "juego": 60, "creatividad": 50, "contemplacion": 70}},
  {"id": 78, "titulo": "Write a beautiful word", "descripcion": "Take a pen and write a beautiful word you like a lot on a clean paper, such as Peace or Calm. Draw large and neat letters at your desk.", "vector_necesidades": {"creatividad": 90, "aprendizaje": 70, "organizacion": 80, "esperanza": 100, "contemplacion": 60}},
  {"id": 79, "titulo": "Hand massage", "descripcion": "Use the thumb of your right hand to give a gentle massage to the palm of your left hand. Draw slow circles across the entire skin with great tenderness in your seat.", "vector_necesidades": {"descanso": 100, "salud": 90, "silencio": 85, "movimiento": 30, "contemplacion": 60}},
  ...
  {"id": 82, "titulo": "Observe a shadow", "descripcion": "Look for a shadow projected on the floor or wall of your current room. Closely observe its dark edges and shapes in absolute silence for one full minute.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "creatividad": 50, "descanso": 75, "naturaleza": 20}},
  {"id": 83, "titulo": "Feel your heartbeat", "descripcion": "Place two of your fingers gently on your left wrist or on your neck in your cozy corner. Stay still feeling the steady and strong beat of your biological pulse.", "vector_necesidades": {"contemplacion": 100, "silencio": 95, "descanso": 90, "salud": 90, "movimiento": 10}},
  ...
  {"id": 160, "titulo": "THE VISUAL REST CHALLENGE", "descripcion": "Look for a spot or an object that is very far away from you through your bedroom window. Keep your eyes on that place fixedly for two minutes to rest your eyes from screens completely.", "vector_necesidades": {"contemplacion": 95, "silencio": 85, "descanso": 90, "naturaleza": 70, "salud": 80}}
   ],
    "SALIR": {
        "agotado": [
...
async def mando_integral(request: Request):
    ...
    if force_recovery_mission:
        ...
        final_misiones_para_frontend = [{
            ...
            "imagen_fondo_categoria": mente # NEW: Add image category for carousel
        }]
        ...
        return JSONResponse({
            ...
            "calidez_humana": random.choice(MANIFIESTOS_ORACULO[mente]) # NEW: Add dynamic human warmth message
        })
        ...
        idioma_key = "EN" if lang == "en" else "ES"
        target_key = f"CASA_{idioma_key}"
        ...
        if not misiones_completas_base: # Fallback if specific language mission not found
            # Ensure fallback also provides correct language
            if idioma_key == "ES":
                final_misiones_casa = [{
                    "id": 801,
             ...
             for m in misiones_completas_base:
                if isinstance(m, dict):
                    final_misiones_casa.append({
                        "id": m.get("id"),
                        "titulo": m.get("titulo"), # Already localized due to target_key
                        "descripcion": m.get("descripcion"), # Already localized due to target_key
        ...
        # NEW: Add image category for carousel in CASA mode
        # For CASA mode, we use the user's current 'mente' for background image selection.
        for mission in misiones_domesticas_finales:
            mission['imagen_fondo_categoria'] = mente

        return JSONResponse({
            "DIRECCIONAMIENTO_MASTER": "MODO_CASA", # Standardized for frontend
            ...
            "legal_notice_es": ADVERTENCIA_LEGAL_ES,
            "legal_notice_en": ADVERTENCIA_LEGAL_EN, # Ensure EN notice is always present
            "drive_prohibited": False,
            "calidez_humana": manif_humano_casa # Use the selected manifesto as human warmth
        })
        ...
        for info_seleccionada in misiones_seleccionadas_raw:
            ...
            if budget == "0":
                ...
                precio_real = "GASTO: Libre. Tu escape." if lang == "es" else "COST: Open. Your escape." # Corrected EN text for consistency

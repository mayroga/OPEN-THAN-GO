...
async def mando_integral(request: Request):
    ...
    if force_recovery_mission:
        ...
        # Tus preguntas fijas del guion original
        preguntas_es = [
        ...
        # Inyectamos la misión formateada incorporando el arreglo con su redirección original intacta
        ...
        # 1. INTERVENCIÓN DOMÉSTICA (MODO CASA) - TOTALMENTE INTACTO COMO ME LO DISTE

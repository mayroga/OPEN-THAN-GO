...
BASE_MISIONES = {
  ...
  # --- PERFIL: VETERANOS
{"id": 501, "titulo": "El refugio de la respiración", "titulo_en": "The breath refuge", "descripcion": "Toma asiento en tu rincón favorito de casa. Coloca tus manos sobre tus rodillas, siente el peso de tu cuerpo bien sostenido y realiza tres respiraciones lentas. Conéctate con la solidez del suelo debajo de ti.", "vector_necesidades": {"silencio": 95, "descanso": 90, "contemplacion": 85, "naturaleza": 70}},
{"id": 502, "titulo": "Anclaje visual en calma", "titulo_en": "Calm visual anchor", "descripcion": "Busca un objeto fijo en tu habitación que no sea una pantalla. Observa sus bordes, su color y sus texturas durante treinta segundos completos. Nota cómo tu mente se estabiliza al fijar tu atención en el presente.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "organizacion": 80, "descanso": 75}},
{"id": 503, "titulo": "Sinfonía del entorno", "titulo_en": "Surrounding symphony", "descripcion": "Cierra tus ojos suavemente en tu sala. Intenta aislar y escuchar el sonido más sutil que ocurra dentro de tu casa en este instante. Permítete habitar este espacio seguro y protegido.", "vector_necesidades": {"silencio": 100, "descanso": 90, "contemplacion": 95, "salud": 80}},
{"id": 504, "titulo": "Suavizado de hombros", "titulo_en": "Shoulder softening", "descripcion": "Eleva tus hombros despacio hacia tus orejas por tres segundos y déjalos caer de golpe de manera sutil. Siente cómo se libera el esfuerzo acumulado en tu espalda alta y respira con soltura.", "vector_necesidades": {"movimiento": 85, "descanso": 90, "salud": 90, "silencio": 70}},
{"id": 505, "titulo": "El reinicio del agua fresca", "titulo_en": "The fresh water reset", "descripcion": "Sirve un vaso de agua fresca en tu cocina. Da un sorbo pequeño y pausado, sintiendo el recorrido del líquido. Es la frescura natural renovando tu energía interna en este instante.", "vector_necesidades": {"agua": 100, "descanso": 80, "silencio": 60, "salud": 85}},
{"id": 506, "titulo": "Manos reconfortantes", "titulo_en": "Comforting hands", "descripcion": "Frota tus manos con energía hasta percibir el calor natural en tu piel. Coloca tus palmas sobre tu pecho, siente el vaivén tranquilo de tu respiración y recúrate en calma en tu hogar.", "vector_necesidades": {"contemplacion": 95, "descanso": 90, "salud": 85, "esperanza": 90}},
{"id": 507, "titulo": "Apertura al horizonte azul", "titulo_en": "Open blue horizon", "descripcion": "Asómate a la ventana por un momento. Dirige tu mirada hacia el cielo o el point más lejano disponible afuera. Deja que tus ojos descansen del entorno cerrado y recupera tu espacio.", "vector_necesidades": {"aire_fresco": 95, "naturaleza": 90, "contemplacion": 100, "descanso": 80}},
{"id": 508, "titulo": "Pasos con plena conciencia", "titulo_en": "Mindful steps", "descripcion": "Ponte de pie con suavidad en tu habitación. Da cinco pasos extremadamente lentos, registrando cómo apoya cada zona de la planta de tu pie sobre el suelo firme. Siente la estabilidad de tu marcha.", "vector_necesidades": {"movimiento": 80, "contemplacion": 85, "silencio": 75, "descanso": 70}},

# --- PERFIL: ADULTO MAYOR
{"id": 511, "titulo": "El estiramiento del amanecer", "titulo_en": "The dawn stretch", "descripcion": "Sentado cómodamente, extiende tus brazos hacia el frente de forma muy suave y abre y cierra los dedos de tus manos cinco veces seguidas. Siente cómo la energía fluye libremente por tus articulaciones.", "vector_necesidades": {"movimiento": 90, "salud": 95, "descanso": 70, "juego": 40}},
{"id": 512, "titulo": "El susurro de las páginas", "titulo_en": "The whisper of pages", "descripcion": "Toma un libro o revista que tengas en casa. Abre una página al azar y detente a observar la primera ilustración o palabra hermosa que encuentres. Alimenta tu mente con calma y curiosidad.", "vector_necesidades": {"aprendizaje": 90, "contemplacion": 85, "silencio": 80, "creatividad": 70}},
{"id": 513, "titulo": "Textura y estabilidad", "titulo_en": "Texture and stability", "descripcion": "Apoya las palmas de tus manos abiertas sobre una mesa de madera o superficie firme en tu hogar. Siente la temperatura y la solidez del mueble, regalándote una grata sensación de equilibrio.", "vector_necesidades": {"contemplacion": 95, "organizacion": 80, "silencio": 70, "descanso": 75}},
{"id": 514, "titulo": "Rotación ligera de tobillos", "titulo_en": "Gentle ankle rotation", "descripcion": "Sentado con la espalda recta, levanta ligeramente un pie y dibuja tres círculos pausados en el aire con tu tobillo. Cambia de pie con total tranquilidad, activando tu motor corporal con ternura.", "vector_necesidades": {"movimiento": 95, "salud": 90, "descanso": 60, "organizacion": 40}},
{"id": 515, "titulo": "Aroma que evoca bienestar", "titulo_en": "Scent evoking wellbeing", "descripcion": "Busca en tu cocina una especia de olor agradable o granos de café. Acércalo a tu nariz por unos segundos y respira hono. Deja que el aroma active tus sentidos de manera reconfortante.", "vector_necesidades": {"naturaleza": 85, "alimentacion": 70, "contemplacion": 90, "silencio": 80}},
{"id": 516, "titulo": "La melodía del recuerdo", "titulo_en": "The melody of memory", "descripcion": "Tararea de forma muy suave y bajita el estribillo de una canción que te gustaba en tu juventud. Siente el ritmo en tu pecho y esboza una sonrisa tranquila en tu espacio seguro.", "vector_necesidades": {"musica": 100, "risa": 80, "creatividad": 70, "esperanza": 90}},
{"id": 517, "titulo": "Abrazo de gratitud interna", "titulo_en": "Inner gratitude hug", "descripcion": "Cruza tus brazos sobre tu pecho con suavidad y apriétate cariñosamente. Trae a tu mente un instante bonito que hayas vivido esta semana y da las gracias en completo silencio.", "vector_necesidades": {"esperanza": 100, "contemplacion": 95, "silencio": 90, "comunidad": 60}},
{"id": 518, "titulo": "El baile de la luz", "titulo_en": "The dance of light", "descripcion": "Observa una zona de la habitación donde entre la luz del sol o se proyecte una sombra. Quédate contemplando ese rincón durante un minuto entero, permitiendo que tu mente se despeje de dudas.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "descanso": 80, "naturaleza": 50}},

# --- PERFIL: TRABAJADORES DEL GOBIERNO
{"id": 521, "titulo": "Cierre del tablero digital", "titulo_en": "Digital dashboard shutdown", "descripcion": "Coloca tu teléfono celular con la pantalla hacia abajo en tu escritorio. Cierra los ojos y visualiza que apagas de manera simbólica todas las alertas, letreros e hilos de mensajes de tu jornada.", "vector_necesidades": {"silencio": 95, "descanso": 90, "organizacion": 80, "contemplacion": 85}},
{"id": 522, "titulo": "Liberación de la postura rígida", "titulo_en": "Stiff posture release", "descripcion": "Entrelaza los dedos de tus manos detrás de tu nuca y lleva tus codos suavemente hacia atrás abriendo tu pecho por unos instantes. Siente cómo tu columna recupera su postura natural y cómoda.", "vector_necesidades": {"movimiento": 90, "salud": 95, "descanso": 70, "organizacion": 50}},
{"id": 523, "titulo": "El conteo regresivo de orden", "titulo_en": "The orderly countdown", "descripcion": "Cuenta mentalmente de manera regresiva del veinte al uno. Hazlo de forma pausada y rítmica entre cada número, permitiendo que tu mente rompa la inercia del procesamiento de tareas.", "vector_necesidades": {"organizacion": 100, "silencio": 90, "descanso": 80, "aprendizaje": 60}},
{"id": 524, "titulo": "Descompresión facial", "titulo_en": "Facial decompression", "descripcion": "Abre grande tu boca con cuidado en tu rincón cómodo y realiza un suave movimiento lateral con tu mandíbula. Siente cómo se desvanece de inmediato la tensión oculta que acumulas en el rostro.", "vector_necesidades": {"movimiento": 80, "salud": 90, "risa": 60, "descanso": 80}},
{"id": 525, "titulo": "Ventilación total del espacio", "titulo_en": "Total room ventilation", "descripcion": "Abre por completo la ventana más cercana de tu casa. Permite que el aire fresco del exterior ruede e inunde la habitación, disolviendo la atmósfera estancada del encierro rutinario.", "vector_necesidades": {"aire_fresco": 100, "naturaleza": 90, "contemplacion": 80, "descanso": 60}},
{"id": 526, "titulo": "El laboratorio creativo", "titulo_en": "The creative laboratory", "descripcion": "Toma una hoja en blanco y dibuja tres círculos grandes perfectos con calma, concentrándote únicamente en el trazo de tu mano. Date permiso de realizar una acción que no requiera evaluación.", "vector_necesidades": {"creatividad": 100, "juego": 80, "silencio": 70, "descanso": 60}},
{"id": 527, "titulo": "Escáner corporal pausado", "titulo_en": "Unhurried body scan", "descripcion": "Toma asiento y apoya tu espalda de forma completa contra la silla. Recorre mentalmente tu cuerpo desde el cuello hasta la punta de los pies, localizando y suavizando los puntos rígidos.", "vector_necesidades": {"descanso": 100, "contemplacion": 95, "silencio": 90, "salud": 85}},
{"id": 528, "titulo": "Mapeo de flujos lejanos", "titulo_en": "Distant flow mapping", "descripcion": "Mira a través de la ventana y localiza el objeto, árbol o casa que esté situado a mayor distancia de ti. Fija tu mirada en ese punto lejano durante un minuto para descansar tu enfoque visual.", "vector_necesidades": {"contemplacion": 95, "silencio": 85, "descanso": 90, "naturaleza": 70}}
   ],
    "CASA_EN": [
  ...
  {"id": 44, "titulo": "Listen to silence", "titulo_en": "Listen to silence", "descripcion": "Stay in complete calm for a few moments in your room and try to listen to the small space of silence that happens that happens between each natural breath in peace.", "descripcion_en": "Stay in complete calm for a few moments in your room and try to listen to the small space of silence that happens that happens between each natural breath in peace.", "vector_necesidades": {"silencio": 100, "contemplacion": 95, "descanso": 90, "aprendizaje": 80, "naturaleza": 70}},
  ...
  # --- PROFILE: VETERANS
{"id": 501, "titulo": "Break the autopilot", "titulo_en": "The breath refuge", "descripcion": "Take a seat in your favorite corner at home. Place your hands on your knees, feel your body weight well supported and take three slow breaths. Connect with the solid floor beneath you.", "vector_necesidades": {"silencio": 95, "descanso": 90, "contemplacion": 85, "naturaleza": 70}},
{"id": 502, "titulo": "Calm visual anchor", "titulo_en": "Calm visual anchor", "descripcion": "Look for a fixed object in your room that is not a screen. Observe its edges, its color, and its textures for thirty full seconds. Notice how your mind stabilizes by focusing your attention on the present.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "organizacion": 80, "descanso": 75}},
{"id": 503, "titulo": "Surrounding symphony", "titulo_en": "Surrounding symphony", "descripcion": "Gently close your eyes in your living room. Try to isolate and listen to the subtlest sound occurring inside your house at this moment. Allow yourself to inhabit this safe and protected space.", "vector_necesidades": {"silencio": 100, "descanso": 90, "contemplacion": 95, "salud": 80}},
{"id": 504, "titulo": "Shoulder softening", "titulo_en": "Shoulder softening", "descripcion": "Slowly raise your shoulders toward your ears for three seconds and drop them subtly. Feel the accumulated burden on your upper back vanish and breathe with complete ease.", "vector_necesidades": {"movimiento": 85, "descanso": 90, "salud": 90, "silencio": 70}},
{"id": 505, "titulo": "The fresh water reset", "titulo_en": "The fresh water reset", "descripcion": "Pour a glass of cool water in your kitchen. Take a small, unhurried sip, feeling the path of the liquid. It is natural freshness renewing your internal energy at this instant.", "vector_necesidades": {"agua": 100, "descanso": 80, "silencio": 60, "salud": 85}},
{"id": 506, "titulo": "Comforting hands", "titulo_en": "Comforting hands", "descripcion": "Rub your hands energetically until you perceive natural warmth on your skin. Place your palms on your chest, feel the peaceful rise and fall of your breath, and lean back calmly in your home.", "vector_necesidades": {"contemplacion": 95, "descanso": 90, "salud": 85, "esperanza": 90}},
{"id": 507, "titulo": "Open blue horizon", "titulo_en": "Open blue horizon", "descripcion": "Look out the window for a moment. Direct your gaze toward the sky or the furthest available point outside. Let your eyes rest from the enclosed environment and reclaim your space.", "vector_necesidades": {"aire_fresco": 95, "naturaleza": 90, "contemplacion": 100, "descanso": 80}},
{"id": 508, "titulo": "Mindful steps", "titulo_en": "Mindful steps", "descripcion": "Stand up gently in your room. Take five extremely slow steps, noticing how each zone of the sole of your foot lands on the firm floor. Feel the stability of your stride.", "vector_necesidades": {"movimiento": 80, "contemplacion": 85, "silencio": 75, "descanso": 70}},

# --- PROFILE: OLDER ADULTS
{"id": 511, "titulo": "The dawn stretch", "titulo_en": "The dawn stretch", "descripcion": "Sitting comfortably, extend your arms forward very gently and open and close your fingers five times in a row. Feel energy flowing freely through your joints.", "vector_necesidades": {"movimiento": 90, "salud": 95, "descanso": 70, "juego": 40}},
{"id": 512, "titulo": "The whisper of pages", "titulo_en": "The whisper of pages", "descripcion": "Take a book or magazine you have at home. Open any page at random and stop to observe the first beautiful illustration or word you find. Feed your mind with calm and curiosity.", "vector_necesidades": {"aprendizaje": 90, "contemplacion": 85, "silencio": 80, "creatividad": 70}},
{"id": 513, "titulo": "Texture and stability", "titulo_en": "Texture and stability", "descripcion": "Place the palms of your open hands on a wooden table or firm surface in your home. Feel the temperature and solidity of the furniture, granting you a pleasant sense of balance.", "vector_necesidades": {"contemplacion": 95, "organizacion": 80, "silencio": 70, "descanso": 75}},
{"id": 514, "titulo": "Gentle ankle rotation", "titulo_en": "Gentle ankle rotation", "descripcion": "Sitting with a straight back, gently lift one foot and draw three unhurried circles in the air with your ankle. Switch feet calmly, activating your bodily engine with tenderness.", "vector_necesidades": {"movimiento": 95, "salud": 90, "descanso": 60, "organizacion": 40}},
{"id": 515, "titulo": "Scent evoking wellbeing", "titulo_en": "Scent evoking wellbeing", "descripcion": "Look for an aromatic spice or coffee beans in your kitchen. Bring it close to your nose for a few seconds and breathe deeply. Let the scent awaken your senses in a comforting way.", "vector_necesidades": {"naturaleza": 85, "alimentacion": 70, "contemplacion": 90, "silencio": 80}},
{"id": 516, "titulo": "La melodía del recuerdo", "titulo_en": "The melody of memory", "descripcion": "Hum very softly and quietly the chorus of a song you liked in your youth. Feel the rhythm in your chest and sketch a peaceful smile in your safe space.", "vector_necesidades": {"musica": 100, "risa": 80, "creatividad": 70, "esperanza": 90}},
{"id": 517, "titulo": "Abrazo de gratitud interna", "titulo_en": "Inner gratitude hug", "descripcion": "Cross your arms over your chest gently and squeeze yourself affectionately. Bring to mind a beautiful moment you experienced this week and give thanks in complete silence.", "vector_necesidades": {"esperanza": 100, "contemplacion": 95, "silencio": 90, "comunidad": 60}},
{"id": 518, "titulo": "El baile de la luz", "titulo_en": "The dance of light", "descripcion": "Observe an area of the room where sunlight enters or a shadow is projected. Contemplate that spot for a full minute, allowing your mind to clear from doubts.", "vector_necesidades": {"contemplacion": 100, "silencio": 90, "descanso": 80, "naturaleza": 50}},

# --- PROFILE: GOVERNMENT WORKERS
{"id": 521, "titulo": "Digital dashboard shutdown", "titulo_en": "Digital dashboard shutdown", "descripcion": "Place your cell phone face down on your desk. Close your eyes and visually switch off all alerts, signs, and message threads from your workday in a symbolic way.", "vector_necesidades": {"silencio": 95, "descanso": 90, "organizacion": 80, "contemplacion": 85}},
{"id": 522, "titulo": "Stiff posture release", "titulo_en": "Stiff posture release", "descripcion": "Interlace your fingers behind your neck and gently bring your elbows back, opening your chest for a few moments. Feel your spine regain its natural and comfortable posture.", "vector_necesidades": {"movimiento": 90, "salud": 95, "descanso": 70, "organizacion": 50}},
{"id": 523, "titulo": "The orderly countdown", "titulo_en": "The orderly countdown", "descripcion": "Count backwards mentally from twenty to one. Do it slowly and rhythmically between each number, allowing your mind to break the momentum of processing tasks.", "vector_necesidades": {"organizacion": 100, "silencio": 90, "descanso": 80, "aprendizaje": 60}},
{"id": 524, "titulo": "Jaw release", "titulo_en": "Facial decompression", "descripcion": "Open your mouth wide carefully in your cozy corner and make a gentle lateral movement with your jaw. Feel the hidden tension you accumulate on your face fade away immediately.", "vector_necesidades": {"movimiento": 80, "salud": 90, "risa": 60, "descanso": 80}},
{"id": 525, "titulo": "Total room ventilation", "titulo_en": "Total room ventilation", "descripcion": "Completely open the nearest window of your house. Allow fresh outdoor air to roll in and flood the room, dissolving the stagnant atmosphere of routine confinement.", "vector_necesidades": {"aire_fresco": 100, "naturaleza": 90, "contemplacion": 80, "descanso": 60}},
{"id": 526, "titulo": "The creative laboratory", "titulo_en": "The creative laboratory", "descripcion": "Take a blank sheet of paper and draw three large perfect circles calmly, focusing solely on the stroke of your hand. Give yourself permission to perform an action that requires no evaluation.", "vector_necesidades": {"creatividad": 100, "juego": 80, "silencio": 70, "descanso": 60}},
{"id": 527, "titulo": "Unhurried body scan", "titulo_en": "Unhurried body scan", "descripcion": "Take a seat and support your back fully against the chair. Mentally scan your body from your neck to the tips of your toes, locating and softening rigid points.", "vector_necesidades": {"descanso": 100, "contemplacion": 95, "silencio": 90, "salud": 85}},
{"id": 528, "titulo": "Distant flow mapping", "titulo_en": "Distant flow mapping", "descripcion": "Look through the window and locate the object, tree, or house situated at the greatest distance from you. Fix your gaze on that distant point for one minute to rest your visual focus.", "vector_necesidades": {"contemplacion": 95, "silencio": 85, "descanso": 90, "naturaleza": 70}}
    ],
    "SALIR": {
        "agotado": [
            ...
            {"id": 721, "titulo": "El Retiro del Monumento Abierto", "titulo_en": "The Open Monument Retreat",
 "porque": "Hoy localiza un monumento cívico o gran plaza de piedra al aire libre en tu ciudad. Si tu mente carga con el peso de expedientes y normativas, este espacio de proporciones monumentales te dará una nueva perspectiva. Camina despacio por la explanada, asimila el aire fresco y descansa en un banco retirado de las oficinas comerciales. Disfruta de la quietud del entorno para recuperar tu autonomía mental.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Plaza monumental o explanada cívica.", "donde_en": "Monument plaza or civic esplanade.",
 "gps": "civic monument public plaza open air",
 "vector_necesidades": {"movimiento": 50, "naturaleza": 40, "silencio": 90, "sombra": 60, "aire_fresco": 95, "contemplacion": 100, "descanso": 90, "organizacion": 80}},

{"id": 722, "titulo": "El Espejo de Agua de la Plaza", "titulo_en": "The Square Water Mirror",
 "porque": "Hoy dirígete a un parque urbano o espacio público que cuente con un espejo de agua o estanque lineal. Si necesitas desvanezer la saturación de datos y pantallas de tu jornada, siéntate frente a la corriente tranquila. Siente la brisa ligera del agua en movimiento y observa el reflejo nítido del cielo. Permite que este diseño equilibrado ordene tus pensamientos de manera orgánica.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Parque urbano con fuentes lineales o canales.", "donde_en": "Urban park with linear fountains or channels.",
 "gps": "urban park reflecting pool landscape",
 "vector_necesidades": {"agua": 100, "naturaleza": 80, "silencio": 85, "sombra": 75, "aire_fresco": 95, "contemplacion": 100, "descanso": 95, "organizacion": 90}},
            ...
            {"id": 711, "titulo": "El Jardín del Rincón Calmo", "titulo_en": "The Calm Corner Garden",
 "porque": "Hoy visita una plaza vecinal pequeña o el jardín público de tu zona. Si sientes cansancio acumulado por la rutina de la semana, camina de forma pausada apreciando el color de los senderos. Busca un asiento cómodo bajo la sombra de un árbol, respira el aire limpio y permite que tus ojos descansen en la vegetación. Levántate renovado, regalándote este respiro reconfortante en total seguridad.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Plaza vecinal o jardín arbolado.", "donde_en": "Neighborhood plaza or wooded garden.",
 "gps": "small public community garden",
 "vector_necesidades": {"movimiento": 40, "naturaleza": 95, "silencio": 90, "sombra": 100, "aire_fresco": 95, "contemplacion": 100, "descanso": 95, "salud": 90}},

{"id": 712, "titulo": "La Fuente de los Reflejos", "titulo_en": "The Reflection Fountain",
 "porque": "Hoy dirígete a un parque céntrico que tenga una fuente de agua o estanque pequeño. Si tu mente busca un espacio ordenado y predecible para equilibrar tus pensamientos, toma asiento cerca de la orilla. Escucha el sonido sutil de las gotas al caer y observe los hermosos destellos de la luz natural sobre la superficie. Regálate esta pausa pasiva para armonizar tu energía interna con tranquilidad.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Parque público con fuente.", "donde_en": "Public park with fountain.",
 "gps": "public plaza fountain sitting area",
 "vector_necesidades": {"agua": 100, "naturaleza": 80, "silencio": 85, "sombra": 80, "aire_fresco": 90, "contemplacion": 100, "descanso": 90, "salud": 85}},
            ...
            {"id": 204, "titulo": "Sabotaje de Espera", "titulo_en": "Waiting Sabotage", "porque": "Hoy dirígete al patio o zona de libros de una escuela cercana. Si tu mente está atrapada en el teléfono y necesitas alimentar tu imaginación con ideas nuevas, camina despacio y en silencio por sus senderos. Respira aire fresco, observa los árboles con tranquilidad, desconéctate de pantallas. Levántate, regálate este respiro intelectual, rompe el piloto automático para reconectar con tu creatividad. Empieza ya.", "porque_en": "Today, head to a nearby school's courtyard or book section. If your mind is phone-trapped and needs new ideas, walk slowly and silently along its paths. Breathe fresh air, observe trees peacefully, disconnect from screens. Get up, grant yourself this intellectual break, break the automatic pilot to reconnect with creativity. Your wellness journey begins now.", "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "", "donde": "Campus universitario o biblioteca pública.", "donde_en": "University campus or public library.", "gps": "university library", "vector_necesidades": {"aprendizaje": 100, "silencio": 90, "contemplacion": 85, "descanso": 70, "aire_fresco": 75, "movimiento": 40}},
             {"id": 701, "titulo": "Refugio Histórico Silencioso", "titulo_en": "Silent Historical Refuge",
 "porque": "Hoy busca un rincón antiguo o memorial público en tu zona. Si tu mente está cansada del bullicio diario, camina con calma por estos pasajes cargados de historia. Toma asiento en un banco de piedra, respira el aire fresco y contempla la inmovilidad de las estructuras. Levántate y regálate este quiebre espacial gratuito para recuperar tu centro en completa paz.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Memorial público o plaza histórica.", "donde_en": "Public memorial or historical plaza.",
 "gps": "historical landmark open air",
 "vector_necesidades": {"movimiento": 30, "naturaleza": 60, "silencio": 95, "sombra": 80, "aire_fresco": 90, "contemplacion": 100, "descanso": 90, "esperanza": 85}},

{"id": 702, "titulo": "El Banco del Estanque", "titulo_en": "The Pond Bench",
 "porque": "Hoy dirígete al estanque público o vivero municipal más cercano. Si tu cuerpo pide un espacio ordenado y sereno para pausar tus pensamientos, encuentra un asiento frente al agua inmóvil. Observa el sutil reflejo de la luz natural sobre las hojas verdes. Levántate, camina a paso lento y permite que la quietud de este refugio regule tu energía biológica de forma gratuita.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Estanque público o jardín vecinal.", "donde_en": "Public pond or neighborhood garden.",
 "gps": "public park with duck pond",
 "vector_necesidades": {"agua": 100, "naturaleza": 95, "silencio": 85, "sombra": 90, "aire_fresco": 95, "contemplacion": 100, "descanso": 95, "salud": 85}}
        ],
        "estresado": [
            ...
            {"id": 723, "titulo": "El Circuito Perimetral Sólido", "titulo_en": "The Solid Perimeter Circuit",
 "porque": "Hoy visita el andador exterior o el circuito peatonal de un parque arbolado o complejo deportivo. Si la tensión institucional acumulada te genera rigidez en la postura, activa tus piernas con firmeza. Realiza una caminata a paso rítmico y constante alrededor del perímetro, concentrándote en el contacto de tus pies con el suelo. Libera la presión del día al aire libre y bajo tu propio control.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Andador perimetral de parque o pista pública.", "donde_en": "Park perimeter walkway or public track.",
 "gps": "public park walking path loop",
 "vector_necesidades": {"movimiento": 100, "sol": 75, "aire_fresco": 90, "organizacion": 85, "contemplacion": 60, "descanso": 20, "salud": 95}},

{"id": 724, "titulo": "La Escalinata del Horizonte Despejado", "titulo_en": "The Clear Horizon Staircase",
 "porque": "Hoy busca un mirador público, anfiteatro al aire libre o escaleras monumentales en una zona abierta. Si tu mente procesa demasiadas directrices cruzadas, cambia de nivel físico para romper la rutina. Sube de manera pausada y constante, usando la fuerza de tus piernas para anclarte al presente. Al llegar a la cima, haz una pausa, respira profundo y contempla las vistas despejadas de la ciudad.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Anfiteatro público o mirador elevado.", "donde_en": "Public amphitheater or elevated overlook.",
 "gps": "public amphitheater outdoor stairs park",
 "vector_necesidades": {"movimiento": 95, "naturaleza": 65, "silencio": 70, "aire_fresco": 95, "contemplacion": 90, "descanso": 30, "salud": 90}},
            ...
            {"id": 713, "titulo": "El Paseo de la Acera Lisa", "titulo_en": "The Smooth Sidewalk Walk",
 "porque": "Hoy busca un andador plano, paseo peatonal seguro o el pasillo exterior de un centro cultural de tu zona. Si experimentas rigidez corporal y necesitas reactivar tu motor biológico en calma, camina a tu propio ritmo. Nota la firmeza y estabilidad de cada paso sobre la superficie regular. Disfruta del aire fresco del entorno, liberando la tensión de tus hombros de manera amable y sin prisas.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Andador peatonal o plaza de la cultura.", "donde_en": "Pedestrian walkway or cultural plaza.",
 "gps": "cultural center outdoor plaza walk",
 "vector_necesidades": {"movimiento": 85, "silencio": 70, "aire_fresco": 95, "organizacion": 80, "contemplacion": 70, "descanso": 40, "salud": 95}},

{"id": 714, "titulo": "La Rampa del Mirador Suave", "titulo_en": "The Gentle Overlook Ramp",
 "porque": "Hoy localiza un sendero accesible, parque con rampas suaves o una zona con barandillas seguras al aire libre. Si los pendientes diarios aceleran tu ritmo somático, utilicemos el entorno para desacelerar. Avanza con zancadas tranquilas, apoyándote firmemente si lo requieres. Al llegar a la zona de descanso, contempla el horizonte despejado, respira profundo y recupera tu estabilidad en paz.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Parque accesible o rampa peatonal.", "donde_en": "Accessible park or pedestrian ramp.",
 "gps": "wheelchair accessible public park trail",
 "vector_necesidades": {"movimiento": 80, "naturaleza": 85, "silencio": 80, "aire_fresco": 90, "contemplacion": 95, "descanso": 50, "salud": 90}},
...
{"id": 703, "titulo": "Pista Deportiva Comunitaria", "titulo_en": "Community Sports Track",
 "porque": "Hoy visita un complejo deportivo al aire libre o circuito vecinal. Si sientes tensión muscular acumulada en tu espalda por el exceso de obligaciones, es momento de activar tus piernas. Camina con paso firme y rítmico cardiovascular alrededor de la pista, sintiendo la solidez de cada zancada bajo tu control. Levántate, libera esa energía saturada y reconecta con tu fortaleza física al aire libre.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Pista de atletismo pública o circuito deportivo.", "donde_en": "Public running track or sports circuit.",
 "gps": "public athletic track open air",
 "vector_necesidades": {"movimiento": 100, "sol": 80, "aire_fresco": 95, "organizacion": 70, "descanso": 10, "salud": 95, "esperanza": 80}},

{"id": 704, "titulo": "El Sendero de la Rampa", "titulo_en": "The Ramp Trail",
 "porque": "Hoy localiza una colina suave, rampa pública o escalinata en un espacio abierto. Si tu mente corre más rápido que tus pasos debido al estrés diario, utilízalo a tu favor. Sube a un ritmo pausado pero constante, concentrándote plenamente en la fuerza de tus articulaciones. Al llegar arriba, detén la marcha, respira profundo y contempla el horizonte libre de pantallas.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Parque elevado o escaleras públicas.", "donde_en": "Elevated park or public stairs.",
 "gps": "scenic overlook park stairs",
 "vector_necesidades": {"movimiento": 95, "naturaleza": 70, "silencio": 60, "aire_fresco": 90, "contemplacion": 80, "descanso": 20, "salud": 90}}
        ],
        "aburrido": [
            ...
            {"id": 725, "titulo": "La Galería de Mapas e Historia", "titulo_en": "The Maps and History Gallery",
 "porque": "Hoy visita la sección de cartografía histórica o el archivo visual de la biblioteca o museo municipal más cercano. Si sientes que tus tareas diarias se han vuelto mecánicas y monótonas, estimula tu mente con un viaje en el tiempo. Examina con calma los trazos antiguos y los planos analógicos en absoluto silencio. Levántate de tu escritorio habitual y despierta tu curiosidad fuera de la red.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Galería de historia o archivo municipal.", "donde_en": "History gallery or municipal archive.",
 "gps": "local history museum municipal archive",
 "vector_necesidades": {"aprendizaje": 100, "creatividad": 90, "silencio": 95, "contemplacion": 95, "descanso": 80, "organizacion": 70}},
            ...
            {"id": 715, "titulo": "El Kiosco de la Música", "titulo_en": "The Music Gazebo",
 "porque": "Hoy camina hacia la plaza central o el kiosco histórico de tu localidad. Si la rutina en casa se siente monótona, refresca tu tarde cambiando de entorno. Siéntate en un banco cercano, observa la arquitectura tradicional y escucha los sonidos alegres del ambiente vecinal. Disfruta de la vida comunitaria que se despliega ante tus ojos y despierta tu curiosidad de manera tranquila.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Kiosco de la plaza central o jardín tradicional.", "donde_en": "Central plaza gazebo or traditional garden.",
 "gps": "historic town square gazebo plaza",
 "vector_necesidades": {"aprendizaje": 80, "creatividad": 75, "silencio": 50, "contemplacion": 95, "descanso": 80, "comunidad": 90, "juego": 60}},
        ...
        {"id": 705, "titulo": "Inmersión Gráfica y Visual", "titulo_en": "Graphic and Visual Immersion",
 "porque": "Hoy dirígete a la sección de archivos, libros ilustrados o mapas antiguos de la biblioteca pública más cercana. Si tus días se sienten monótonos y planos, despierta tu agudeza óptica perdiéndote entre registros visuales del pasado. Pasa las páginas despacio, en absoluto silencio acústico, apreciando los detalles analógicos. Levántate, rompe la rutina digital y activa tu curiosidad intelectual.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Zona de lectura o biblioteca municipal.", "donde_en": "Reading area or municipal library.",
 "gps": "public library local history room",
 "vector_necesidades": {"aprendizaje": 100, "creatividad": 95, "silencio": 100, "contemplacion": 90, "descanso": 80, "organizacion": 60}}
        ],
        "cansado": [
            ...
            {"id": 726, "titulo": "El Pabellón del Silencio Estructurado", "titulo_en": "The Structured Silence Pavilion",
 "porque": "Hoy camina con tranquilidad hacia el portal sombreado, atrio o claustro de un centro cultural de arquitectura clásica. Si experimentas fatiga mental por la constante toma de decisiones, este entorno simétrico y ordenado mitigará tu cansancio. Toma asiento en una banca firme, apoya bien la espalda y descansa la mirada en las columnas. Siente cómo se desacelera tu ritmo interno.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Claustro sombreado o patio de arquitectura clásica.", "donde_en": "Shaded cloister or classical architecture courtyard.",
 "gps": "cultural center classical arcade pavilion",
 "vector_necesidades": {"descanso": 100, "silencio": 95, "contemplacion": 95, "organizacion": 90, "esperanza": 80, "movimiento": 15, "sombra": 100}},
            ...
            {"id": 716, "titulo": "El Atrio del Descanso Sereno", "titulo_en": "The Serene Rest Atrium",
 "porque": "Hoy dirígete al patio interior, portal o vestíbulo sombreado de un edificio histórico o casa de cultura en tu zona. Si experimentas fatiga o pesadez física, este rincón resguardado te ofrecerá un excelente descanso. Acomódate en un asiento firme, apoya tu espalda de forma completa y contempla los detalles de los arcos en silencio. Siente cómo la frescura del espacio mitiga el agobio.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Atrio sombreado o patio colonial abierto.", "donde_en": "Shaded atrium or open colonial courtyard.",
 "gps": "cultural center open courtyard historic",
 "vector_necesidades": {"descanso": 100, "silencio": 95, "contemplacion": 95, "organizacion": 80, "esperanza": 85, "movimiento": 10, "sombra": 100}},
        ...
        {"id": 706, "titulo": "El Vestíbulo del Reposo Ordenado", "titulo_en": "The Orderly Rest Lobby",
 "porque": "Hoy camina tranquilamente hacia el vestíbulo abierto o patio interior de un hotel boutique o edificio de arquitectura clásica cercano. Si tu cuerpo carga con fatiga de decisiones, este entorno espacioso y estético te ofrecerá un quiebre protector. Toma asiento en un sillón cómodo, mantén la espalda recta y descansa tu mirada contemplando un punto lejano en silencio. Siente cómo tu ritmo interno se desacelera.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Zona de descanso o lobby de arquitectura abierta.", "donde_en": "Lounge area or open architecture lobby.",
 "gps": "historic design hotel lobby",
 "vector_necesidades": {"descanso": 100, "silencio": 90, "contemplacion": 95, "organizacion": 80, "esperanza": 80, "movimiento": 20}}
      }
    },
        "ansioso": [
            ...
            {"id": 727, "titulo": "El Refugio Botánico y Lineal", "titulo_en": "The Linear Botanical Refuge",
 "porque": "Hoy busca un invernadero municipal, jardín botánico o pasaje cubierto de plantas en tu zona. Si las exigencias del entorno institucional te generan inquietud, el diseño orgánico y pacífico de la naturaleza te devolverá la estabilidad. Camina despacio bajo los arcos verdes, asimila la humedad del ambiente y observa la geometría de las hojas. Permite que este oasis armonice tu bienestar.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Invernadero público o pasaje botánico techado.", "donde_en": "Public greenhouse or covered botanical path.",
 "gps": "municipal botanical conservatory",
 "vector_necesidades": {"naturaleza": 100, "silencio": 90, "aire_fresco": 95, "contemplacion": 100, "descanso": 90, "organizacion": 95, "salud": 90, "sombra": 85}},

{"id": 728, "titulo": "La Plaza del Movimiento Cotidiano", "titulo_en": "The Everyday Movement Plaza",
 "porque": "Hoy visita una plaza comunitaria, parque canino o zona peatonal con vida social suelta en tu vecindario. Si te encuentras atrapado en pensamientos rígidos o burocráticos, necesitas un impacto externo de vitalidad espontánea. Siéntate en un banco cómodo y observa las dinámicas ligeras de las mascotas o las interacciones del entorno. Deja que esa frescura libre de agendas alivie tu tensión.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Plaza peatonal o parque de esparcimiento.", "donde_en": "Pedestrian plaza or recreation park.",
 "gps": "urban pedestrian plaza park benches",
 "vector_necesidades": {"juego": 90, "risa": 90, "comunidad": 95, "movimiento": 50, "naturaleza": 75, "aire_fresco": 90, "esperanza": 95, "descanso": 70}},
            ...
            {"id": 717, "titulo": "El Paseo Botánico Protegido", "titulo_en": "The Protected Botanical Walk",
 "porque": "Hoy visita un vivero comunitario, invernadero municipal o pasaje arbolado muy tranquilo. Si experimentas una sensación de prisa interna, rodearte del orden natural y pausado de las plantas te devolverá la calma. Camina despacio bajo la sombra, aprecia el aroma de la tierra y las flores, y toca suavemente una hoja verde. Permite que la estabilidad del entorno armonice tu bienestar.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Vivero botánico o invernadero de flores.", "donde_en": "Botanical nursery or flower greenhouse.",
 "gps": "local flower nursery greenhouse",
 "vector_necesidades": {"naturaleza": 100, "silencio": 90, "aire_fresco": 95, "contemplacion": 100, "descanso": 90, "organizacion": 90, "salud": 95, "sombra": 90}},

{"id": 718, "titulo": "El Banco Frente al Palomar", "titulo_en": "The Bench Facing the Aviary",
 "porque": "Hoy busca una zona tranquila en el parque central donde se reúnan aves o mascotas en un espacio seguro. Si notas que tus pensamientos se vuelven rígidos o repetitivos, distrae tu enfoque de manera amable. Toma asiento en una banca cómoda y concéntrate en observar el aleteo libre o el movimiento espontáneo del entorno. Deja que esa ligereza natural suavice tu jornada sin esfuerzos.",
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "",
 "donde": "Área de descanso en parque vecinal.", "donde_en": "Resting area in neighborhood park.",
 "gps": "public park aviary sitting benches",
 "vector_necesidades": {"juego": 80, "risa": 85, "comunidad": 80, "movimiento": 40, "naturaleza": 90, "aire_fresco": 90, "esperanza": 95, "descanso": 85}},
        ...
        {"id": 707, "titulo": "El Santuario Invernadero", "titulo_en": "The Greenhouse Sanctuary", 
 "porque": "Hoy busca un jardín botánico techado, invernadero o vivero público local. Si la prisa mental te genera inquietud, la regularidad y el orden orgánico de las plantas te regalarán calma somática. Avanza despacio por los senderos techados, percibiendo la humedad y el aroma a tierra húmeda. Toca con cuidado la hoja de una planta, asimila su textura y recupere su estabilidad interna en este oasis.", 
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "", 
 "donde": "Invernadero público o vivero botánico.", "donde_en": "Public greenhouse or botanical nursery.", 
 "gps": "botanical conservatory garden", 
 "vector_necesidades": {"naturaleza": 100, "silencio": 90, "aire_fresco": 95, "contemplacion": 100, "descanso": 90, "organizacion": 85, "salud": 90, "sombra": 80}},

{"id": 708, "titulo": "Parque Recreativo y Dinámico", "titulo_en": "Dynamic Recreation Park", 
 "porque": "Hoy visita un área recreativa comunitaria, parque canino o zona de esparcimiento vecinal. Si te atrapan pensamientos circulares rígidos, necesitas un impacto externo de vitalidad espontánea. Siéntate en un banco seguro y concéntrate en observar las dinámicas alegres de las mascotas o las interacciones sueltas del entorno. Permite que esa ligereza inocente equilibre tus nervios y disuelva el agobio.", 
 "que_hacer": "", "que_hacer_en": "", "cuando": "", "cuando_en": "", "para_que": "", "para_que_en": "", 
 "donde": "Parque comunitario o zona de esparcimiento.", "donde_en": "Community park or recreation zone.", 
...
# INYECTAR EN: main.py (Como una nueva variable global o dentro de tu esquema de datos)
# ==========================================================================================
...
EJERCICIOS_BIENESTAR = {
    "VETERANOS": [
        {
            "id": 801, 
            "nombre": "Alineación y Apoyo Terrestre", 
            "nombre_en": "Ground Support Alignment",
            "instruccion": "Ponte de pie con los pies separados a la distancia de tus hombros. Siente el contacto firme de tus plantas con el suelo. Balancea tu peso suavemente hacia adelante y hacia atrás tres veces, permitiendo que tus rodillas mantengan una flexión muy ligera y cómoda. Siente la estabilidad de tu base.",
            "instruccion_en": "Stand with your feet shoulder-width apart. Feel the firm contact of your soles with the ground. Gently rock your weight forward and backward three times, allowing your knees to maintain a very slight and comfortable bend. Feel the stability of your base."
        },
        {
            "id": 802, 
            "nombre": "Rotación de Muñecas en Calma", 
    ...
    "GOBIERNO": [
        {
            "id": 821, 
            "nombre": "Liberación de la Postura de Escritorio", 
            "nombre_en": "Desk Posture Release",
            "instruccion": "Sentado firmemente, entrelaza los dedos de tus manos hacia el frente y empuja suavemente las palmas hacia adelante, permitiendo que tu espalda alta se curve de forma muy ligera y cómoda. Siente cómo se mitiga la carga acumulada en tus omóplatos durante tres segundos y relaja.",
            "instruccion_en": "Sitting firmly, interlace your fingers forward and gently push your palms outward, allowing your upper back to curve very slightly and comfortably. Feel the accumulated load on your shoulder blades mitigate for three seconds and relax."
        },
        {
            "id": 822, 
            "nombre": "El Respiro del Enfoque Lejano", 
            "nombre_en": "Distant Focus Respite",
            "instruccion": "Desvía tu mirada de la pantalla por completo. Busca un punto fijo en la habitación o a través de la ventana que esté a una distancia cómoda. Parpadea tres veces despacio, permitiendo que los músculos de tu rostro y tus ojos descansen en ese balance visual.",
            "instruccion_en": "Divert your gaze completely from the screen. Look for a fixed spot in the room or through the window at a comfortable distance. Blink three times slowly, allowing your facial muscles and eyes to rest in that visual balance."
        }
    ]
...
async def mando_integral(request: Request):
    ...
    if force_recovery_mission:
        ...
        # ==========================================================================================
        # CEREBRO CENTRAL UNIFICADO - INTELIGENCIA DE SEGMENTACIÓN MULTICANAL (ESTILO FACEBOOK)
        # ==========================================================================================
        ...
        # DETECTOR DE ESPECIALIDAD TRABAJO: Si lo pide explícitamente se le da, si no, se bloquea lo corporativo
        pide_trabajo = any(palabra in marca_limpia or palabra in sintoma_limpio for palabra in ["trabajo", "empleo", "work", "job", "curriculum", "vacantes"])
        ...
        if pide_trabajo:
            ...
            # ALGORITMO DE DESVIACIÓN DE LA PRISIÓN MENTAL: Cada canal es una especialidad humana libre de dogmas
            matriz_intencional_vibrante = {
                "ansioso": {
                    "maps": [
                        "explore+luxury+botanical+gardens+and+scenic+architectural+water+fountains+near+me",
                        "explore+hidden+panoramic+rooftops+and+sunset+city+lookouts+near+me",
                        "explore+aesthetic+cat+cafes+and+exotic+indoor+greenhouses+near+me",
                        "explore+boutique+record+stores+and+vintage+vinyl+lounges+near+me"
                    ],
                ...
                "estresado": {
                    "maps": [
                        "explore+cozy+independent+bookstores+with+hidden+patios+and+gardens+near+me",
                        "explore+independent+comic+bookstores+and+retro+toy+collectors+near+me",
                        "explore+scenic+lake+drives+and+isolated+forest+lookouts+near+me",
                        "explore+artisan+japanese+tea+houses+with+zen+gardens+near+me"
                    ],
                ...
                "aburrido": {
                    "maps": [
                        "explore+retro+arcade+and+neon+pinball+venues+near+me",
                        "explore+vibrant+urban+street+art+graffiti+walks+and+flea+markets+near+me",
                        "explore+go+kart+racing+or+indoor+climbing+centers+near+me",
                        "explore+interactive+theme+parks+and+live+immersive+entertainment+hubs+near+me"
                    ],
                ...
                "agotado": {
                    "maps": [
                        "explore+gourmet+specialty+coffee+roasters+and+luxury+pastry+shops+near+me",
                        "explore+thermal+mineral+baths+and+relaxation+spa+lounges+near+me",
                        "explore+historic+hidden+cloisters+and+secret+palace+courtyards+near+me",
                        "explore+design+hotels+with+panoramic+terraces+and+views+near+me"
                    ],
                ...
                "cansado": {
                    "maps": [
                        "explore+interactive+sensory+modern+art+galleries+and+light+shows+near+me",
                        "explore+scenic+coastal+lookouts+or+mountain+passes+near+me",
                        "explore+boutique+antique+shops+and+curiosity+markets+near+me",
                        "explore+independent+theaters+and+vintage+art+cinemas+near+me"
                    ],
            ...
            elif perfil_tipo == "solo": modificador_compania = "+hidden+gems+aesthetic"

...
        target_brands = [
            "walmart", "amazon", "youtube", # Only the three requested brands for this specific feature
            "costco", "starbucks", "mcdonald", # Other brands from original logic (kept but not explicitly asked for here)

**`main.py`**
            ...
            "agotado": [
                {
                    ...
                    <mark style="background-color: yellow;">"donde": "Parque con árboles frondosos", "donde_en": "Park with leafy trees",</mark>
                    <mark style="background-color: yellow;">"gps": "parque+con+sombra+gratis",</mark>
                    "vector_necesidades": {
                ...
                <mark style="background-color: yellow;">{
                    "id": 106,
                    "titulo": "Respiración al aire libre", "titulo_en": "Outdoor Breathing",
                    "porque": "Necesitas oxigenar tu cuerpo y tu mente para recargar energías.", "porque_en": "You need to oxygenate your body and mind to recharge energy.",
                    "que_hacer": "Encuentra un espacio abierto. Cierra los ojos y haz 10 respiraciones profundas.", "que_hacer_en": "Find an open space. Close your eyes and take 10 deep breaths.",
                    "donde": "Plaza pública o mirador", "donde_en": "Public square or viewpoint",
                    "gps": "plaza+publica+aire+fresco+gratis",
                    "vector_necesidades": {
                        "movimiento": 30, "naturaleza": 70, "silencio": 70, "agua": 10, "sol": 60, "sombra": 50,
                        "aire_fresco": 100, "creatividad": 20, "comunidad": 40, "aprendizaje": 10, "juego": 10,
                        "contemplacion": 90, "trabajo": 5, "descanso": 95, "organizacion": 15, "alimentacion": 0,
                        "musica": 5, "risa": 15, "esperanza": 80
                    }
                },
                {
                    "id": 107,
                    "titulo": "Contacto con la tierra", "titulo_en": "Earth Contact",
                    "porque": "Te ayudará a enraizarte y liberar la energía acumulada.", "porque_en": "It will help you to ground yourself and release accumulated energy.",
                    "que_hacer": "Quítate los zapatos y camina descalzo sobre césped o tierra por unos minutos.", "que_hacer_en": "Take off your shoes and walk barefoot on grass or earth for a few minutes.",
                    "donde": "Zona verde de acceso libre", "donde_en": "Free access green area",
                    "gps": "zona+verde+para+caminar+descalzo+gratis",
                    "vector_necesidades": {
                        "movimiento": 50, "naturaleza": 100, "silencio": 60, "agua": 30, "sol": 70, "sombra": 40,
                        "aire_fresco": 90, "creatividad": 10, "comunidad": 20, "aprendizaje": 5, "juego": 20,
                        "contemplacion": 80, "trabajo": 0, "descanso": 85, "organizacion": 10, "alimentacion": 0,
                        "musica": 5, "risa": 10, "esperanza": 75
                    }
                }</mark>
            ],
            "estresado": [
                {
                    ...
                    <mark style="background-color: yellow;">"donde": "Escalera pública o rampa para ejercicio", "donde_en": "Public stairs or ramp for exercise",</mark>
                    <mark style="background-color: yellow;">"gps": "escaleras+publicas+para+ejercicio+gratis",</mark>
                    "vector_necesidades": {
                ...
                <mark style="background-color: yellow;">{
                    "id": 108,
                    "titulo": "Descarga de energía", "titulo_en": "Energy Release",
                    "porque": "La tensión se acumula, y necesitas liberarla de forma activa.", "porque_en": "Tension builds up, and you need to release it actively.",
                    "que_hacer": "Encuentra un espacio amplio. Salta o sacude tus extremidades vigorosamente por un minuto.", "que_hacer_en": "Find an open space. Jump or shake your limbs vigorously for one minute.",
                    "donde": "Cancha pública o zona verde", "donde_en": "Public court or green area",
                    "gps": "cancha+publica+ejercicio+libre+gratis",
                    "vector_necesidades": {
                        "movimiento": 100, "naturaleza": 50, "silencio": 40, "agua": 20, "sol": 80, "sombra": 30,
                        "aire_fresco": 90, "creatividad": 20, "comunidad": 30, "aprendizaje": 10, "juego": 60,
                        "contemplacion": 20, "trabajo": 10, "descanso": 20, "organizacion": 10, "alimentacion": 0,
                        "musica": 40, "risa": 50, "esperanza": 80
                    }
                },
                {
                    "id": 109,
                    "titulo": "Ritmo de pasos", "titulo_en": "Pacing Rhythm",
                    "porque": "Un ritmo constante ayuda a organizar tus pensamientos y relajar el cuerpo.", "porque_en": "A steady rhythm helps organize your thoughts and relax your body.",
                    "que_hacer": "Camina a paso rápido y constante por un sendero o acera. Concéntrate en el sonido de tus pasos.", "que_hacer_en": "Walk at a fast, steady pace on a path or sidewalk. Focus on the sound of your steps.",
                    "donde": "Sendero o acera amplia", "donde_en": "Path or wide sidewalk",
                    "gps": "sendero+para+caminar+gratis",
                    "vector_necesidades": {
                        "movimiento": 90, "naturaleza": 60, "silencio": 50, "agua": 10, "sol": 70, "sombra": 50,
                        "aire_fresco": 85, "creatividad": 10, "comunidad": 40, "aprendizaje": 20, "juego": 30,
                        "contemplacion": 70, "trabajo": 15, "descanso": 30, "organizacion": 40, "alimentacion": 0,
                        "musica": 20, "risa": 25, "esperanza": 70
                    }
                }</mark>
            ],
            "aburrido": [
                {
                    ...
                    <mark style="background-color: yellow;">"donde": "Calle con murales o arte público", "donde_en": "Street with murals or public art",</mark>
                    <mark style="background-color: yellow;">"gps": "murales+arte+urbano+gratis",</mark>
                    "vector_necesidades": {
                ...
                <mark style="background-color: yellow;">{
                    "id": 110,
                    "titulo": "Explorador de barrio", "titulo_en": "Neighborhood Explorer",
                    "porque": "La rutina te ciega a lo nuevo que te rodea. Redescubre tu entorno.", "porque_en": "Routine blinds you to the new around you. Rediscover your surroundings.",
                    "que_hacer": "Toma una calle que nunca hayas recorrido cerca de tu casa y observa cada detalle.", "que_hacer_en": "Take a street you've never walked near your home and observe every detail.",
                    "donde": "Una calle aleatoria de tu zona", "donde_en": "A random street in your area",
                    "gps": "recorrido+urbano+desconocido+gratis",
                    "vector_necesidades": {
                        "movimiento": 70, "naturaleza": 30, "silencio": 50, "agua": 10, "sol": 70, "sombra": 40,
                        "aire_fresco": 80, "creatividad": 60, "comunidad": 50, "aprendizaje": 80, "juego": 70,
                        "contemplacion": 70, "trabajo": 10, "descanso": 20, "organizacion": 30, "alimentacion": 10,
                        "musica": 20, "risa": 40, "esperanza": 90
                    }
                },
                {
                    "id": 111,
                    "titulo": "Caza de nubes", "titulo_en": "Cloud Hunting",
                    "porque": "La simplicidad del cielo es un lienzo infinito para tu imaginación.", "porque_en": "The simplicity of the sky is an infinite canvas for your imagination.",
                    "que_hacer": "Busca un lugar al aire libre. Túmbate y observa las formas de las nubes.", "que_hacer_en": "Find an outdoor spot. Lie down and observe the shapes of the clouds.",
                    "donde": "Campo abierto o parque", "donde_en": "Open field or park",
                    "gps": "parque+observar+nubes+gratis",
                    "vector_necesidades": {
                        "movimiento": 10, "naturaleza": 90, "silencio": 80, "agua": 5, "sol": 90, "sombra": 60,
                        "aire_fresco": 95, "creatividad": 100, "comunidad": 10, "aprendizaje": 50, "juego": 40,
                        "contemplacion": 100, "trabajo": 0, "descanso": 80, "organizacion": 5, "alimentacion": 0,
                        "musica": 10, "risa": 30, "esperanza": 95
                    }
                }</mark>
            ],
            "cansado": [
                {
                    ...
                    <mark style="background-color: yellow;">"donde": "Biblioteca pública silenciosa", "donde_en": "Quiet public library",</mark>
                    <mark style="background-color: yellow;">"gps": "biblioteca+publica+silenciosa+gratis",</mark>
                    "vector_necesidades": {
                ...
                <mark style="background-color: yellow;">{
                    "id": 112,
                    "titulo": "Pausa en cafetería", "titulo_en": "Cafe Break",
                    "porque": "Un cambio de ambiente suave puede renovar tu energía sin exigirte mucho.", "porque_en": "A gentle change of scenery can renew your energy without demanding much.",
                    "que_hacer": "Encuentra una cafetería con un buen sillón. Solo siéntate y observa sin consumir.", "que_hacer_en": "Find a cafe with a comfy armchair. Just sit and observe without consuming.",
                    "donde": "Cafetería con asientos cómodos", "donde_en": "Cafe with comfortable seating",
                    "gps": "cafeteria+con+sillones+para+descansar+gratis",
                    "vector_necesidades": {
                        "movimiento": 20, "naturaleza": 5, "silencio": 60, "agua": 5, "sol": 20, "sombra": 90,
                        "aire_fresco": 60, "creatividad": 30, "comunidad": 60, "aprendizaje": 20, "juego": 10,
                        "contemplacion": 80, "trabajo": 5, "descanso": 90, "organizacion": 50, "alimentacion": 0,
                        "musica": 70, "risa": 20, "esperanza": 65
                    }
                },
                {
                    "id": 113,
                    "titulo": "Búsqueda de tesoros", "titulo_en": "Treasure Hunt",
                    "porque": "Reactivar tu curiosidad te sacará del cansancio mental.", "porque_en": "Reactivating your curiosity will pull you out of mental fatigue.",
                    "que_hacer": "Busca un objeto específico (ej. una hoja de color inusual) en tu barrio.", "que_hacer_en": "Look for a specific object (e.g., an unusual colored leaf) in your neighborhood.",
                    "donde": "Calles de tu barrio o parque", "donde_en": "Neighborhood streets or park",
                    "gps": "actividades+gratuitas+en+mi+barrio",
                    "vector_necesidades": {
                        "movimiento": 60, "naturaleza": 70, "silencio": 50, "agua": 10, "sol": 60, "sombra": 40,
                        "aire_fresco": 80, "creatividad": 80, "comunidad": 40, "aprendizaje": 70, "juego": 90,
                        "contemplacion": 60, "trabajo": 5, "descanso": 40, "organizacion": 30, "alimentacion": 0,
                        "musica": 10, "risa": 70, "esperanza": 80
                    }
                }</mark>
            ],
            "ansioso": [
                {
                    ...
                    <mark style="background-color: yellow;">"donde": "Fuente pública con agua en movimiento", "donde_en": "Public fountain with moving water",</mark>
                    <mark style="background-color: yellow;">"gps": "fuente+publica+con+agua+corriendo+gratis",</mark>
                    "vector_necesidades": {
                ...
                <mark style="background-color: yellow;">{
                    "id": 114,
                    "titulo": "Contar elementos naturales", "titulo_en": "Count Natural Elements",
                    "porque": "Fijar tu atención en detalles reduce el ciclo de pensamientos ansiosos.", "porque_en": "Focusing your attention on details reduces the cycle of anxious thoughts.",
                    "que_hacer": "Sal a un área verde y cuenta objetos específicos, como 10 hojas verdes.", "que_hacer_en": "Go to a green area and count specific objects, like 10 green leaves.",
                    "donde": "Jardín público o zona arbolada", "donde_en": "Public garden or wooded area",
                    "gps": "jardin+publico+observacion+gratis",
                    "vector_necesidades": {
                        "movimiento": 30, "naturaleza": 90, "silencio": 80, "agua": 10, "sol": 60, "sombra": 70,
                        "aire_fresco": 90, "creatividad": 40, "comunidad": 20, "aprendizaje": 30, "juego": 20,
                        "contemplacion": 95, "trabajo": 0, "descanso": 80, "organizacion": 10, "alimentacion": 0,
                        "musica": 5, "risa": 10, "esperanza": 85
                    }
                },
                {
                    "id": 115,
                    "titulo": "Observar el horizonte", "titulo_en": "Observe the Horizon",
                    "porque": "Ampliar tu vista ayuda a la mente a ver más allá de la preocupación inmediata.", "porque_en": "Widening your view helps the mind see beyond immediate worry.",
                    "que_hacer": "Busca un lugar alto con vista despejada y mira lo más lejos que puedas.", "que_hacer_en": "Find a high place with a clear view and look as far as you can.",
                    "donde": "Mirador o colina de acceso libre", "donde_en": "Free access viewpoint or hill",
                    "gps": "mirador+panoramico+gratis",
                    "vector_necesidades": {
                        "movimiento": 20, "naturaleza": 80, "silencio": 85, "agua": 5, "sol": 70, "sombra": 50,
                        "aire_fresco": 95, "creatividad": 30, "comunidad": 15, "aprendizaje": 20, "juego": 10,
                        "contemplacion": 100, "trabajo": 0, "descanso": 90, "organizacion": 5, "alimentacion": 0,
    ...
    BIG_TECH_RESOURCES = {
        ...
        <mark style="background-color: yellow;"># Removed staffing agencies as per user's request: "no se puede mandar al usuario a trabajaqr,a buscar trabajos en agencias de trabajo"</mark>
    ...
    async def mando_integral(request: Request):
        ...
        <mark style="background-color: yellow;"># Corrected: Implement more robust anti-repetition logic for SALIR mode
        # Filter out the last recommended mission from the current mente category
        candidatos_para_evaluar = [opc for opc in opciones_salir_candidatas if opc.get("id") != last_recommendation_id]

        # If after filtering, there are no candidates for the selected 'mente' (e.g., only one option and it was the last one)
        if not candidatos_para_evaluar:
            # Broaden search: consider all SALIR options, excluding the last one
            todas_opciones_salir = []
            for category_list in BASE_MISIONES["SALIR"].values():
                todas_opciones_salir.extend(category_list)
            
            # Ensure we don't re-recommend the very last ID if other options are available
            candidatos_para_evaluar = [opc for opc in todas_opciones_salir if opc.get("id") != last_recommendation_id]
            
            # If still empty (meaning the last_recommendation_id is the only mission across ALL categories, or no missions at all)
            if not candidatos_para_evaluar:
                # Fallback: if there's only one mission overall, pick it. If there are multiple,
                # but only the last_recommendation_id is left, pick a random one from the original mente category
                # to avoid error, although it will be a repeat. This scenario should be rare with sufficient missions.
                info_seleccionada = opciones_salir_candidatas[0] if opciones_salir_candidatas else list(BASE_MISIONES["SALIR"].values())[0][0]
                # Skip scoring, as it's a forced fallback
                mejor_score = -1 # Reset to ensure no score is "better" than this forced pick
            else:
                # Proceed to scoring with the broader pool
                info_seleccionada = None # Reset for scoring process
        else:
            info_seleccionada = None # Reset for scoring process
        </mark>
        ...
        # info_seleccionada = None # Already initialized above or potentially set by fallback
        mejor_score = -1
       
        <mark style="background-color: yellow;"># Only score if info_seleccionada was not already determined by the forced fallback above</mark>
        if not info_seleccionada:
            for opc in candidatos_para_evaluar: # Use the filtered/broadened list
        ...
        <mark style="background-color: yellow;"># If info_seleccionada is still None after scoring (e.g., no candidates, or all scored 0)
        # Use a truly random choice from *all* SALIR options, still trying to avoid the last one if possible
        if not info_seleccionada:
            all_fallback_options = []
            for category_list in BASE_MISIONES["SALIR"].values():
                all_fallback_options.extend(category_list)
            
            # Try to find one that isn't the last_recommendation_id
            non_repeated_fallback = [opc for opc in all_fallback_options if opc.get("id") != last_recommendation_id]
            if non_repeated_fallback:
                info_seleccionada = random.choice(non_repeated_fallback)
            else:
                # If everything else fails (only one mission in the entire system, or it's the only one left)
                info_seleccionada = random.choice(all_fallback_options) # Forced repetition as a last resort
        </mark>
        ...
        <mark style="background-color: yellow;"># Removed sensitive financial keywords that triggered job search or stressed the user
        ...
        # Adjusted keywords to focus on consumption rather than employment/debt directly for the interceptor
        palabras_criticas = ["comprar", "gastar", "dinero", "ofertas", "amazon", "walmart", "costco", "tienda", "consumo", "economy", "money", "buy", "spend", "deals", "shop"]
        </mark>
        ...
        # Determine dynamic "PARA QUÉ" (Why) phrase based on 'mente'
        <mark style="background-color: yellow;">para_que_es = {
            "agotado": "Para recargar tu energía y encontrar la calma interior.",
            "estresado": "Para liberar tensiones y reconectar con tu paz.",
            "aburrido": "Para romper la rutina y redescubrir la alegría de vivir.",
            "cansado": "Para revitalizar tu espíritu y encontrar un nuevo enfoque.",
            "ansioso": "Para centrar tu mente y disolver la preocupación."
        }.get(mente, "Para recordar que la vida es más que la rutina diaria.")
        para_que_en = {
            "agotado": "To recharge your energy and find inner calm.",
            "estresado": "To release tension and reconnect with your peace.",
            "aburrido": "To break the routine and rediscover the joy of living.",
            "cansado": "To revitalize your spirit and find a new focus.",
            "ansioso": "To center your mind and dissolve worry."
        }.get(mente, "To remember that life is more than daily routine.")
        </mark>

        # Check for critical keywords in 'desahogo' to activate the interceptor
        if any(p in desahogo for p in palabras_criticas):
            canal_multimedia = random.choice(["SPOTIFY", "YOUTUBE"]) # <mark style="background-color: yellow;">Removed STAFFING option</mark>
            if canal_multimedia == "SPOTIFY":
                ...
                guia_masticada = (
                    ...
                    "PARA QUÉ: Detener el impulso de consumir innecesariamente y encontrar paz." # <mark style="background-color: yellow;">Rephrased PARA QUÉ</mark>
                ) if lang == "es" else (
                    "TARGET: Free Spotify.\n"
                    "WHAT TO DO: Listen to nature sounds in silence.\n"
                    "WHY: Stop the urge to consume unnecessarily and find peace." # <mark style="background-color: yellow;">Rephrased WHY</mark>
                )
            ...
            <mark style="background-color: yellow;"># Removed STAFFING block completely
            # else: # STAFFING
            ...
            if lang == "en":
                guia_masticada = (
                    ...
                    f"FOR WHAT: {para_que_en}\n" # <mark style="background-color: yellow;">Used dynamic PARA QUÉ</mark>
                    f"{quienes_van}\n{precio_real}"
                )
        ...
        if gps_query:
            ...
            else: # For Spotify/YouTube, link_base is already the full URL

...
# File: main.py - SECCIÓN 1 DE 2 (NÚCLEO BASE E INFRAESTRUCTURA)
...
# Asegura la existencia física del directorio estático
if not os.path.exists("static"):
    os.makedirs("static")

app.mount("/static", StaticFiles(directory="static"), name="static")

# Tu base de misiones original completa sin recortes ni alteraciones
BASE_MISIONES = {
    "CASA": [
        ...
        {"id": 13, "titulo": "Foco en lo olvidado", "elige": "Elige una tarea mínima que ignorabas. Hazla ahora. Termínala."},
    ...
    "CASA_EXTRA": [
        ...
        {"id": 32, "ciencia": "Conciencia aire", "descripcion": "Siente el aire frío entrar, el cálido salir."},
    ...
    "SALIR": {
        "agotado": [
            {"titulo": "Sombra de árbol", "porque": "Tu mente necesita descansar de las luces de la pantalla.", "que_hacer": "Toca corteza de árbol, siente su textura. Quédate bajo sombra densa.", "donde": "Un parque verde.", "gps": "parks+with+shade+"}
        ],
        "estresado": [
        ...
        "aburrido": [
            {"titulo": "Paseo de colores", "porque": "Estás repitiendo los mismos días y necesitas ver cosas nuevos.", "que_hacer": "Camina despacio por la calle. Encuentra dibujos grandes en las paredes de tu zona.", "donde": "Calle con murales.", "gps": "street+art+"}
        ]
    }
}

# Recursos de infraestructura Big Tech integrados
BIG_TECH_RESOURCES = {
...
# OPEN THAN GO SYSTEM - Kernel Absolute Engine V.5.5.0
# Company: May Roga LLC
# File: main.py - SECCIÓN 2 DE 2 (LÓGICA LOGÍSTICA COMPLETA)
...
async def mando_integral(request: Request):
    ...
    if any(pal in desahogo for pal in interceptores_compra):
        ...
        # Rutas bilingües con instrucciones sencillas nivel niño de 9 años (REPARADO Y SANEADO AQUÍ)
        if lang == "en":
            traducciones_guia = {
    ...
    # FÓRMULA GEOGRÁFICA UNIVERSAL ENLACE VIVO: Borra los huecos y concatena cualquier ZIP de USA

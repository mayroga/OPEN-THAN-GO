...
"CATALOGO_RETOS_ES": [
  {"id": 201, "titulo": "EL RETO DE LA SUSCRIPCIÓN OLVIDADA", "descripcion": "Regálate un momento para abrir tu correo electrónico o la aplicación de tu banco con total tranquilidad. Busca y cancela alguna suscripción o servicio digital que ya no utilices en tu vida diaria. Recuperar el control de tus finanzas también es cuidar tu bienestar interno en paz.", "img": "gratitude.svg"},
  {"id": 202, "titulo": "EL RETO DE LOS TRES GASTOS", "descripcion": "Abre una nota limpia en tu teléfono móvil y escribe únicamente los tres gastos obligatorios de esta semana presente. No pienses en todo el mes ni te satures con el futuro. Concéntrate solo en los días que vienen. Tu mente recupera su orden y equilibrio ya.", "img": "words.svg"},
  {"id": 203, "titulo": "EL RETO DEL ORDEN DIGITAL", "descripcion": "Explora la galería de fotos de tu teléfono celular en este instante. Borra veinte capturas de pantalla antiguas o imágenes repetidas que ya no te sirvan para nada. Organizar tu dispositivo te ayudará a tranquilizar tus pensamientos y a despejar el ruido de tu cabeza hoy.", "img": "observe.svg"},
  {"id": 204, "titulo": "EL RETO DEL SILENCIO", "descripcion": "Pon en modo de silencio absoluto las notificaciones de tu teléfono móvil que te causen alertas o mensajes continuos durante una hora completa. Regálale un descanso tranquilo y un respiro pasivo a tu atención consciente lejos de la prisa digital. Tu calma regresa en este segundo.", "img": "silence.svg"},
  {"id": 205, "titulo": "EL RETO DE LA GRATITUD", "descripcion": "Escribe en una hoja de papel limpio tres cosas hermosas que tienes en tu vida el día de hoy y que hace un tiempo deseabas con todo tu corazón. Recuerda con alegría todo tu progreso humano y permite que este pensamiento positivo disuelva toda tu ansiedad ahora.", "img": "gratitude.svg"},
  {"id": 206, "titulo": "EL RETO DE LA RESPIRACIÓN", "descripcion": "Levántate muy despacio de tu asiento actual sin prisa alguna. Camina con calma hacia la cocina, sirve un vaso con agua fresca y tómalo con total tranquilidad antes de regresar a tus tareas respirando lento. Concéntrate en esa agradable sensación física de bienestar en tu cuerpo.", "img": "stretch.svg"},
  {"id": 207, "titulo": "EL RETO DE LA VENTANA", "descripcion": "Abre la ventana más cercana de tu casa durante dos minutos exactos en este momento. Guarda tu teléfono in el bolsillo, relaja tus brazos y quédate observando la inmensidad del cielo en absoluto silencio. Deja que el aire fresco te limpie el rostro y te dé paz.", "img": "nature_sound.svg"},
...
"CATALOGO_RETOS_EN": [
  {"id": 201, "titulo_en": "THE FORGOTTEN SUBSCRIPTION CHALLENGE", "descripcion_en": "Take a moment to open your email or your bank application with total peace of mind. Find and cancel an application or digital service that you no longer use in your daily life. Regaining control of your finances is also about taking care of your inner well-being.", "img": "gratitude.svg"},
  {"id": 202, "titulo_en": "THE THREE EXPENSES CHALLENGE", "descripcion_en": "Open a clean note on your phone and write down only the three mandatory expenses for this present week. Do not think about the whole month or overwhelm yourself with the future. Focus only on the days ahead. Your mind recovers its order and balance right now.", "img": "words.svg"},
  {"id": 203, "titulo_en": "THE DIGITAL ORDER CHALLENGE", "descripcion_en": "Explore the photo gallery on your mobile phone at this instant. Delete twenty old screenshots or repeated pictures that no longer serve you at all. Organizing your device helps to quiet your thoughts and clear the noise from your head today. Experience this quietness in peace.", "img": "observe.svg"},
  {"id": 204, "titulo_en": "THE SILENCE CHALLENGE", "descripcion_en": "Mute the notifications on your mobile phone that cause you continuous alerts or messages for one full hour. Give a peaceful rest and a passive break to your mindful attention far from the digital rush. Your calm returns in this very second of total and absolute well-being.", "img": "silence.svg"},
  {"id": 205, "titulo_en": "THE GRATITUDE CHALLENGE", "descripcion_en": "Write down on a clean sheet of paper three beautiful things you have in your life today that you wished for with all your heart some time ago. Remember all your human progress with true joy and allow this positive thought to dissolve all your anxiety right now.", "img": "gratitude.svg"},

...
const KERNEL = {
    ...
    async ejecutar() {
        ...
        container.classList.remove('hidden');
                ...
                // ==========================================================================================
                // LÓGICA DE ACTIVACIÓN DIRECTA: ROMPEMOS EL CANDADO DE RED PARA LIBERAR AL ORÁCULO
                // ==========================================================================================
                if (this.tipoEscapeGlobal === "ACCION_CAMPO") { 
                    
                    // Conservamos tu actualización local si es que el servidor la envía
                    ...
                    // ==========================================================================================
                    // TU REPRODUCTOR SECUENCIAL EN ORDEN ESTRICTO OPERANDO AL 100%
                    // ==========================================================================================

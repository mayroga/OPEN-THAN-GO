...
const KERNEL = {
    ...
    CATALOGO_PREGUNTAS_ES: [
        ...
        "¿Conduces sin destino solo para escape del encierro en tu propio entorno?",
        "¿Mantienes hábitos por costumbre, sintiendo que te anestesian de tu reality?",
    ...
    activarBotonMandoLibreInicial() {
        ...
        if (btnLibre) {
            ...
            const isTextareaEmpty = textarea && textarea.value.trim().length <= 3;
    ...
    iniciarSalidaConcreta(selectedMission) {
        ...
        let speechText = (this.idiomaActual === 'es' ? this.datosLugarGlobal.destino_titulo : this.datosLugarGlobal.destino_titulo_en || this.datosLugarGlobal.destino_titulo) + ". " + rawInstruccion;
    ...
    iniciarRelojEnfocadoCasa(container, t) {
        ...
        this.timerEnfocado = setInterval(() => {
            ...
            if (this.timeLeft < 600 && (600 - this.timeLeft) % 20 === 0 && (600 - this.timeLeft) !== 0) {
                ...
                if (pasoAudioIdx >= 0 && typeof AUDIOS_SECUENCIALES_CASA_ES !== "undefined") {
                    ...
                    if (catalogAudios && pasoAudioIdx < catalogAudios.length) {
                        ...
                        if (recordatorioTexto) this.hablar(recordatorioTexto);
                    }
                }
            }
    ...
    reiniciarExperiencia() {
        ...
        if (document.getElementById('pantalla-cierre')) document.getElementById('pantalla-cierre').classList.add('hidden');
        if (document.getElementById('wrapper-interactive')) document.getElementById('wrapper-interactive').classList.add('hidden');
        if (document.getElementById('wrapper-form')) document.getElementById('wrapper-form').classList.remove('hidden');
        if (document.getElementById('inp-text-libre')) document.getElementById('inp-text-libre').value = "";

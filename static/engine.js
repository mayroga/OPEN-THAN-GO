...
function cambiarModalidad(esSalir) {
    ...
    if(document.getElementById('inp-state')) document.getElementById('inp-state').parentElement.style.style.display = displayGeografia;
    if(document.getElementById('inp-region')) document.getElementById('inp-region').parentElement.style.style.display = displayGeografia;
    if(document.getElementById('inp-zip')) document.getElementById('inp-zip').parentElement.style.style.display = displayGeografia;
}

...
const KERNEL = { 
    ...
    CATALOGO_PREGUNTAS: [ 
        ...
        "¿Te da pánico equivocarte si dejas la rutina cómoda y segura que ya conozes?",
    ...
    ], // <-- COMÁ DE TRANSICIÓN REGLAMENTARIA COLOCADA LIMPIAMENTE
    // ========================================================================= 
    ...
    mostrarResultadoOraculo(datos) { 
        ...
        // SINCRO DE TEXTOS BILINGÜES PARA LA CUENTA ATRÁS DE CAMPO SANEADA
        const t = {
    ...
    iniciarRelojClinicoCasa(container, t) { 
        ...
        // DECLARACIÓN INTEGRADA AL ENTORNO DE PROPIEDADES DE CONTROL DEL MOTOR
        ...
        if (circleElement) { 
            circleElement.onclick = () => { 
                if (this.contadorToques < 10) { 
                    let adelantoSegundos = this.secuenciaAdelantos[this.contadorToques] || 5; 
        ...
        this.timerClinico = setInterval(() => { 
            ...
            if (this.relojRealSegundos < 600 && this.relojRealSegundos % 20 === 0) { 
                ...
                let recordatorioTexto = this.AUDIOS_SECUENCIALES_CASA[pasoAudioIdx]; 

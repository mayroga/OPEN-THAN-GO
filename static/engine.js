**`static/engine.js`**
    ...
    const KERNEL = {
        ...
        CATALOGO_PREGUNTAS_ES: [
            ...
            <mark style="background-color: yellow;">"¿Abres redes sociales por inercia, comparando tu día con imágenes idealizadas?",</mark>
            <mark style="background-color: yellow;">"¿Te pierdes en contenido de video que olvidas en pocos segundos, buscando llenar un vacío?",</mark>
            <mark style="background-color: yellow;">"¿Usas música para ahogar el ruido mental y la inquietud de tu día a día?",</mark>
            <mark style="background-color: yellow;">"¿Buscas novedades en tiendas online solo por la expectativa de recibir algo?",</mark>
            <mark style="background-color: yellow;">"¿Paseas por grandes superficies gastando sin rumbo fijo, solo por inercia?",</mark>
            <mark style="background-color: yellow;">"¿Sientes que lo digital te desconectó de la capacidad de observar el mundo real en calma?",</mark>

            // Bloque 2: Evasión y Rutina Física (Comida, Descanso y Movimiento)
            <mark style="background-color: yellow;">"¿Inviertes mucho en experiencias pasajeras buscando una satisfacción que se desvanece rápido?",</mark>
            <mark style="background-color: yellow;">"¿Te refugias en espacios ajenos huyendo de situaciones que te acompañan a todas partes?",</mark>
            <mark style="background-color: yellow;">"¿Conduces sin destino solo para escapar del encierro en tu propio entorno?",</mark>
            <mark style="background-color: yellow;">"¿Mantienes hábitos por costumbre, sintiendo que te anestesian de tu realidad?",</mark>
            <mark style="background-color: yellow;">"¿Te cuesta romper tu rutina por miedo a la incomodidad o el esfuerzo físico?",</mark>
            <mark style="background-color: yellow;">"¿Tu cuerpo te pide actividad, pero eliges la comodidad estática del sofá?",</mark>

            // Bloque 3: Distracción Nocturna y Aislamiento Social
            <mark style="background-color: yellow;">"¿Buscas ambientes ruidosos para silenciar los pensamientos que te inquietan?",</mark>
            <mark style="background-color: yellow;">"¿Bailas rodeado de gente, sintiendo a la vez una profunda soledad interior?",</mark>
            <mark style="background-color: yellow;">"¿Asistes a eventos sociales por compromiso, anhelando volver a tu propio espacio?",</mark>
            <mark style="background-color: yellow;">"¿Necesitas estímulos externos para sobrellevar conversaciones monótonas?",</mark>
            <mark style="background-color: yellow;">"¿Aceptas la compañía, pero te escudas detrás de tu dispositivo móvil?",</mark>
            <mark style="background-color: yellow;">"¿Proyectas una imagen de perfección social para ocultar tu verdadero sentir?",</mark>

            // Bloque 4: Entorno Familiar y Distancia Emocional
            <mark style="background-color: yellow;">"¿Existen roces constantes con tus seres queridos que impiden la armonía en casa?",</mark>
            <mark style="background-color: yellow;">"¿Sientes desinterés o apatía ante reuniones familiares inevitables?",</mark>
            <mark style="background-color: yellow;">"¿Compartes techo, pero la distancia emocional te hace sentir como extraños?",</mark>
            <mark style="background-color: yellow;">"¿La visita de un familiar te genera tensión en vez de verdadera paz y conexión?",</mark>
            <mark style="background-color: yellow;">"¿La añoranza por los que están lejos te paraliza y te impide vivir tu presente?",</mark>
            <mark style="background-color: yellow;">"¿Sientes que las presiones compartidas están creando silencios en tus relaciones?",</mark>

            // Bloque 5: Evasión por Viajes y Fugas de la Realidad
            <mark style="background-color: yellow;">"¿Subestimas lo que tienes cerca, soñando con escapes lejanos que te son inalcanzables?",</mark>
            <mark style="background-color: yellow;">"¿Deseas una huida total para que el cambio de escenario resuelva tus crisis internas?",</mark>
            <mark style="background-color: yellow;">"¿Crees que la solución a tu insatisfacción es un cambio radical de ubicación?",</mark>
            <mark style="background-color: yellow;">"¿Planeas grandes gastos en ocio que podrían comprometer tu estabilidad futura?",</mark>
            <mark style="background-color: yellow;">"¿Buscas imágenes de paisajes distantes porque perdiste la capacidad de asombrarte con tu propio cielo?",</mark>
            <mark style="background-color: yellow;">"¿Te sientes atado a tu lugar y asumes que la libertad requiere de un boleto a otro sitio?",</mark>

            // Bloque 6: Vulnerabilidad Corporal y Sensaciones
            <mark style="background-color: yellow;">"¿Aplazas tu bienestar físico por miedo a los costos o las complicaciones?",</mark>
            <mark style="background-color: yellow;">"¿Sientes molestias en el cuerpo causadas por la acumulación de estrés diario?",</mark>
            <mark style="background-color: yellow;">"¿Te preocupa cómo el sistema impactaría tu salud y la estabilidad de los tuyos?",</mark>
            <mark style="background-color: yellow;">"¿Sientes opresión en el pecho por la prisa del entorno y la incertidumbre del futuro?",</mark>
            <mark style="background-color: yellow;">"¿Tu bienestar se desgasta en una actividad que te exige demasiado a cambio de recompensas?",</mark>
            <mark style="background-color: yellow;">"¿Has olvidado el consuelo de una respiración profunda, libre de cualquier preocupación?",</mark>

            // Bloque 7: El Espejismo Material y Vacío Existencial
            <mark style="background-color: yellow;">"¿Buscas la tranquilidad en un entorno natural, pero tu mente sigue en el bucle de las responsabilidades?",</mark>
            <mark style="background-color: yellow;">"¿Tienes estabilidad y comodidades, pero una insatisfacción crónica te consume por dentro?",</mark>
            <mark style="background-color: yellow;">"¿Crees que la adquisición de propiedades te dará un sentido de pertenencia o identidad?",</mark>
            <mark style="background-color: yellow;">"¿Te paraliza la idea de dejar la seguridad de lo conocido, por miedo a un paso incierto?",</mark>
            <mark style="background-color: yellow;">"¿Te comparas con las posesiones y el estilo de vida de los demás?",</mark>
            <mark style="background-color: yellow;">"¿Sientes que la vida se te escapa dedicando todo a acumular cosas sin sentido?",</mark>
            ...
            <mark style="background-color: yellow;">"¿Estás cansado de repetir patrones que consumen tu libertad y energía?",</mark>
        ...
        CATALOGO_PREGUNTAS_EN: [
            ...
            <mark style="background-color: yellow;">"Do you open social media out of inertia, comparing your day to idealized images?",</mark>
            <mark style="background-color: yellow;">"Do you get lost in video content that you forget in a few seconds, trying to fill a void?",</mark>
            <mark style="background-color: yellow;">"Do you use music to drown out mental noise and daily restlessness?",</mark>
            <mark style="background-color: yellow;">"Do you look for new items in online stores just for the anticipation of receiving something?",</mark>
            <mark style="background-color: yellow;">"Do you wander through big stores spending aimlessly, just out of inertia?",</mark>
            <mark style="background-color: yellow;">"Do you feel like technology disconnected you from the ability to calmly observe the real world?",</mark>

            // Block 2: Escape Consumption and Physical Routine (Food, Rest, and Movement)
            <mark style="background-color: yellow;">"Do you overspend on fleeting experiences looking for satisfaction that quickly fades?",</mark>
            <mark style="background-color: yellow;">"Do you take refuge in external spaces fleeing situations that accompany you everywhere?",</mark>
            <mark style="background-color: yellow;">"Do you drive aimlessly just to escape being cooped up in your own environment?",</mark>
            <mark style="background-color: yellow;">"Do you maintain habits out of custom, feeling that they numb you to your reality?",</mark>
            <mark style="background-color: yellow;">"Are you afraid to break your routine for fear of discomfort or physical effort?",</mark>
            <mark style="background-color: yellow;">"Does your body crave activity, but you choose the static comfort of the couch?",</mark>

            // Block 3: Nightly Distraction and Social Isolation
            <mark style="background-color: yellow;">"Do you seek noisy environments to silence the thoughts that trouble you?",</mark>
            <mark style="background-color: yellow;">"Do you dance surrounded by people, while feeling a deep inner loneliness?",</mark>
            <mark style="background-color: yellow;">"Do you attend social events out of obligation, wishing to return to your own space?",</mark>
            <mark style="background-color: yellow;">"Do you need external stimuli to endure monotonous conversations?",</mark>
            <mark style="background-color: yellow;">"Do you accept company but shield yourself behind your mobile device?",</mark>
            <mark style="background-color: yellow;">"Do you project an image of social perfection to hide your true feelings?",</mark>

            // Block 4: Family Environment and Emotional Distance
            <mark style="background-color: yellow;">"Do you constantly argue with your loved ones over differences that prevent harmony at home?",</mark>
            <mark style="background-color: yellow;">"Do you feel disinterest or apathy before inevitable family gatherings?",</mark>
            <mark style="background-color: yellow;">"Do you live under the same roof with your family but emotional distance makes you feel like strangers?",</mark>
            <mark style="background-color: yellow;">"Does a family visit generate tension instead of true peace and connection?",</mark>
            <mark style="background-color: yellow;">"Does longing for those far away paralyze you and prevent you from living your present?",</mark>
            <mark style="background-color: yellow;">"Do you feel that shared pressures are creating silences in your relationships?",</mark>

            // Block 5: Travel Evasion and Escapes from Reality
            <mark style="background-color: yellow;">"Do you underestimate what's near you, dreaming of distant escapes that are unattainable?",</mark>
            <mark style="background-color: yellow;">"Do you wish for a total escape so that a change of scenery resolves your internal crises?",</mark>
            <mark style="background-color: yellow;">"Do you believe that the solution to your dissatisfaction is a radical change of location?",</mark>
            <mark style="background-color: yellow;">"Do you plan large expenses on leisure that could compromise your future stability?",</mark>
            <mark style="background-color: yellow;">"Do you search for images of distant landscapes because you've lost the ability to be amazed by your own sky?",</mark>
            <mark style="background-color: yellow;">"Do you feel tied to your place and assume that freedom requires a ticket to another location?",</mark>

            // Block 6: Bodily Vulnerability and Sensations
            <mark style="background-color: yellow;">"Do you postpone your physical well-being for fear of costs or complications?",</mark>
            <mark style="background-color: yellow;">"Do you feel physical discomfort caused by the accumulation of daily stress?",</mark>
            <mark style="background-color: yellow;">"Are you concerned about how the system would impact your health and your family's stability?",</mark>
            <mark style="background-color: yellow;">"Do you feel tightness in your chest from the rush of your environment and the uncertainty of the future?",</mark>
            <mark style="background-color: yellow;">"Is your well-being wearing out in an activity that demands too much in exchange for rewards?",</mark>
            <mark style="background-color: yellow;">"Have you forgotten the comfort of a deep breath, free from any worry?",</mark>

            // Block 7: The Material Mirage and Existential Void
            <mark style="background-color: yellow;">"Do you seek tranquility in a natural environment, but your mind remains in the loop of responsibilities?",</mark>
            <mark style="background-color: yellow;">"Do you have stability and comforts but a chronic dissatisfaction consumes you within?",</mark>
            <mark style="background-color: yellow;">"Do you believe that acquiring property will give you a sense of belonging or identity?",</mark>
            <mark style="background-color: yellow;">"Does the idea of leaving the security of the known paralyze you, for fear of an uncertain step?",</mark>
            <mark style="background-color: yellow;">"Do you secretly compare yourself to the status and possessions of others?",</mark>
            <mark style="background-color: yellow;">"Do you feel time slipping through your fingers, dedicating everything to accumulating meaningless things?",</mark>
            ...
            <mark style="background-color: yellow;">"Are you tired of repeating patterns that consume your freedom and energy?",</mark>
        ...
        AUDIOS_SECUENCIALES_CASA_ES: [
            ...
            <mark style="background-color: yellow;">"Suelta los hombros despacio. Deja caer todo el peso físico y mental de la semana.",</mark>
            <mark style="background-color: yellow;">"No pienses en responsabilidades ahora. No mires tu lista de tareas. Respira ya.",</mark>
            ...
            <mark style="background-color: yellow;">"Eres mucho más grande que tus preocupaciones. Respira hondo y despacio.",</mark>
            ...
            <mark style="background-color: yellow;">"Las oportunidades regresarán, pero este segundo de calma no se repite.",</mark>
            ...
            <mark style="background-color: yellow;">"Tu mente es fuerte. Has domado el miedo a las presiones de hoy.",</mark>
        ...
        AUDIOS_SECUENCIALES_CASA_EN: [
            ...
            <mark style="background-color: yellow;">"Slowly relax your shoulders. Let all the physical and mental weight of the week fall away.",</mark>
            <mark style="background-color: yellow;">"Don't think about responsibilities now. Don't look at your to-do list. Breathe now.",</mark>
            ...
            <mark style="background-color: yellow;">"You are much bigger than your worries. Breathe deeply and slowly.",</mark>
            ...
            <mark style="background-color: yellow;">"Opportunities will return, but this second of calm will not repeat.",</mark>
            ...
            <mark style="background-color: yellow;">"Your mind is strong. You have tamed the fear of today's pressures.",</mark>
        ...
        despertarInicial() {
            ...
            const saludos_es = [
                <mark style="background-color: yellow;">"Bienvenido a ópen dán go. Tu escape inteligente. Escucha mis preguntas en pantalla.",</mark>
                <mark style="background-color: yellow;">"ópen dán go está activo. Concéntrate un momento. Mira las opciones en tu pantalla ya.",</mark>
                <mark style="background-color: yellow;">"Entraste a ópen dán go. Rompamos tu piloto automático ahora mismo. Toca lo que sientes hoy."</mark>
            ];
            const saludos_en = [
                <mark style="background-color: yellow;">"Welcome to open than go. Your smart escape. Listen to my questions on screen.",</mark>
                <mark style="background-color: yellow;">"open than go is active. Focus for a moment. Look at the options on your screen now.",</mark>
                <mark style="background-color: yellow;">"You entered open than go. Let's break your autopilot right now. Tap what you feel today."</mark>
            ];
